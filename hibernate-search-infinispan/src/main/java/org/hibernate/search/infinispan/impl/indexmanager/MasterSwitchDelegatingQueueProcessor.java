...
public class MasterSwitchDelegatingQueueProcessor implements BackendQueueProcessor {
	...
	public MasterSwitchDelegatingQueueProcessor(BackendQueueProcessor localMaster,
	...
	public void applyStreamWork(LuceneWork singleOperation, IndexingMonitor monitor) {
		if ( remoteMaster.isMasterLocal() ) {
			log.applyingChangeListLocally( singleOperation );
			localMaster.applyStreamWork( singleOperation, monitor );
		}
		else {
			log.applyingChangeListRemotely( singleOperation );
