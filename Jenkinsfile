...
stage('Configure') {
	...
	this.environments = AlternativeMultiMap.create([
			...
			localElasticsearch: [
					...
					new LocalElasticsearchBuildEnvironment(version: '7.17.27', condition: TestCondition.AFTER_MERGE),
					...
					new LocalElasticsearchBuildEnvironment(version: '8.17.2', condition: TestCondition.BEFORE_MERGE, isDefault: true),
