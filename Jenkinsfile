...
stage('Configure') {
	...
	this.environments = AlternativeMultiMap.create([
			...
			localElasticsearch: [
					...
					new LocalElasticsearchBuildEnvironment(version: '7.17.19', condition: TestCondition.AFTER_MERGE),
					...
					new LocalElasticsearchBuildEnvironment(version: '8.13.0', condition: TestCondition.BEFORE_MERGE, isDefault: true),
			...
			amazonElasticsearch: [
					...
					new AmazonOpenSearchServiceBuildEnvironment(version: '2.11', condition: TestCondition.AFTER_MERGE),
					// Also test static credentials, but only for the latest version
					new AmazonOpenSearchServiceBuildEnvironment(version: '2.11', condition: TestCondition.AFTER_MERGE, staticCredentials: true)
			]
	])
