...
stage('Configure') {
	...
	this.environments = AlternativeMultiMap.create([
			...
			localElasticsearch: [
					...
					new LocalElasticsearchBuildEnvironment(version: '7.17.22', condition: TestCondition.AFTER_MERGE),
					...
					new LocalElasticsearchBuildEnvironment(version: '8.14.2', condition: TestCondition.BEFORE_MERGE, isDefault: true),
