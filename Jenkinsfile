...
stage('Configure') {
	...
	this.environments = AlternativeMultiMap.create([
			...
			localElasticsearch: [
					...
					new LocalElasticsearchBuildEnvironment(version: '7.17.15', condition: TestCondition.AFTER_MERGE),
					...
					new LocalElasticsearchBuildEnvironment(version: '8.11.3', condition: TestCondition.BEFORE_MERGE, isDefault: true),
