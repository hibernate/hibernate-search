...
stage('Configure') {
	...
	this.environments = AlternativeMultiMap.create([
			...
			localElasticsearch: [
					...
					new LocalElasticsearchBuildEnvironment(version: '7.17.21', condition: TestCondition.AFTER_MERGE),
					...
					new LocalElasticsearchBuildEnvironment(version: '8.13.3', condition: TestCondition.BEFORE_MERGE, isDefault: true),
