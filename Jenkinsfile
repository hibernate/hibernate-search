...
stage('Configure') {
	...
	this.environments = AlternativeMultiMap.create([
			...
			localElasticsearch: [
					...
					new LocalElasticsearchBuildEnvironment(version: '9.2.3', condition: TestCondition.BEFORE_MERGE, isDefault: true),
                    ...
                    new LocalOpenSearchBuildEnvironment(version: '3.4.0', condition: TestCondition.BEFORE_MERGE),
