...
stage('Configure') {
	...
	this.environments = AlternativeMultiMap.create([
			...
			localElasticsearch: [
					...
					new LocalElasticsearchBuildEnvironment(version: '9.3.1', condition: TestCondition.BEFORE_MERGE, isDefault: true),
                    ...
                    new LocalOpenSearchBuildEnvironment(version: '3.6.0', condition: TestCondition.BEFORE_MERGE),
