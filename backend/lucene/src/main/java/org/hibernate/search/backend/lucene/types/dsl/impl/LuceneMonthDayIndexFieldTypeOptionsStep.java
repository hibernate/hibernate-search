...
class LuceneMonthDayIndexFieldTypeOptionsStep
		extends AbstractLuceneStandardIndexFieldTypeOptionsStep<LuceneMonthDayIndexFieldTypeOptionsStep, MonthDay> {
	...
	@Override
	public LuceneMonthDayIndexFieldTypeOptionsStep sortable(Sortable sortable) {
