...
public class StringFieldSortBuilderFactory implements LuceneFieldSortBuilderFactory {

	private static final Log log = LoggerFactory.make( Log.class, MethodHandles.lookup() );

	private final LuceneFieldConverter<String, ?> converter;
	...
	public boolean isDslCompatibleWith(LuceneFieldSortBuilderFactory obj) {
		...
		if ( obj.getClass() != StringFieldSortBuilderFactory.class ) {
			return false;
		}

		StringFieldSortBuilderFactory other = (StringFieldSortBuilderFactory) obj;
