...
public abstract class AbstractLuceneIndexField implements IndexFieldDescriptor,
		LuceneSearchIndexNodeContext {
	protected static final Log log = LoggerFactory.make( Log.class, MethodHandles.lookup() );

	protected final LuceneIndexCompositeNode parent;
	...
	public AbstractLuceneIndexField(LuceneIndexCompositeNode parent, String relativeName,
	...
	@Override
	public abstract LuceneIndexObjectField toObjectField();

	@Override
	public abstract LuceneIndexValueField<?> toValueField();

	@Override
	public LuceneIndexCompositeNode parent() {
		return parent;
	}
