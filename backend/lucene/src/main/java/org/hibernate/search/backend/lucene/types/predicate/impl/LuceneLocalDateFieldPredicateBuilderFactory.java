...
public final class LuceneLocalDateFieldPredicateBuilderFactory
		extends AbstractLuceneStandardFieldPredicateBuilderFactory<LocalDateFieldConverter> {

	public LuceneLocalDateFieldPredicateBuilderFactory(LocalDateFieldConverter converter) {
		super( converter );
	}
