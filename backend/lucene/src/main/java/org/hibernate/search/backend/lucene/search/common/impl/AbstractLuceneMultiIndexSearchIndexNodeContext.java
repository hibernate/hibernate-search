...
abstract class AbstractLuceneMultiIndexSearchIndexNodeContext<E extends LuceneSearchIndexNodeContext>
		implements LuceneSearchIndexNodeContext {
	...
	AbstractLuceneMultiIndexSearchIndexNodeContext(LuceneSearchIndexScope scope, String absolutePath,
	...
	public final List<String> nestedPathHierarchy() {
		return getFromElementIfCompatible( LuceneSearchIndexNodeContext::nestedPathHierarchy,
