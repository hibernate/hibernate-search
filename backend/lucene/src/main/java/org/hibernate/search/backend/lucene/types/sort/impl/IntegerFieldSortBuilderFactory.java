...
public class IntegerFieldSortBuilderFactory implements LuceneFieldSortBuilderFactory {

	private static final Log log = LoggerFactory.make( Log.class, MethodHandles.lookup() );

	private final LuceneFieldConverter<Integer, ?> converter;
	...
	public boolean isDslCompatibleWith(LuceneFieldSortBuilderFactory obj) {
		...
		if ( obj.getClass() != IntegerFieldSortBuilderFactory.class ) {
			return false;
		}

		IntegerFieldSortBuilderFactory other = (IntegerFieldSortBuilderFactory) obj;
