...
class LuceneYearIndexFieldTypeContext
		extends AbstractLuceneStandardIndexFieldTypeContext<LuceneYearIndexFieldTypeContext, Year> {

	private Sortable sortable = Sortable.DEFAULT;

	LuceneYearIndexFieldTypeContext(LuceneIndexFieldTypeBuildContext buildContext) {
		super( buildContext, Year.class );
	}

	@Override
	public LuceneYearIndexFieldTypeContext sortable(Sortable sortable) {
	...
	@Override
	protected LuceneYearIndexFieldTypeContext thisAsS() {
		return this;
	}
}
