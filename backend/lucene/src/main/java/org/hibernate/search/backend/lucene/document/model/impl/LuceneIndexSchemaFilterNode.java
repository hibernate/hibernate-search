...
public class LuceneIndexSchemaFilterNode<F extends FilterFactory> {
	...
	public LuceneIndexSchemaFilterNode(LuceneIndexSchemaObjectNode parent, String relativeFilterName,
		...
		if ( !nestedPathHierarchy.isEmpty() ) {
			nestedDocumentPath = nestedPathHierarchy
				.get( nestedDocumentPath.length() - 1 );
		}
