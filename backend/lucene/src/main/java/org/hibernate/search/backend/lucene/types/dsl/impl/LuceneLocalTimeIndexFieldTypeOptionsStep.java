...
class LuceneLocalTimeIndexFieldTypeOptionsStep
		extends AbstractLuceneStandardIndexFieldTypeOptionsStep<LuceneLocalTimeIndexFieldTypeOptionsStep, LocalTime> {
	...
	@Override
	public LuceneLocalTimeIndexFieldTypeOptionsStep sortable(Sortable sortable) {
