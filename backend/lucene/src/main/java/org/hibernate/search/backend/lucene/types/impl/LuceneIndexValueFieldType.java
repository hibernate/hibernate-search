...
public class LuceneIndexValueFieldType<F>
		implements IndexValueFieldTypeDescriptor, IndexFieldType<F>, LuceneSearchIndexValueFieldTypeContext<F> {
	...
	private final Map<SearchQueryElementTypeKey<?>, AbstractLuceneValueFieldSearchQueryElementFactory<?, F>> queryElementFactories;
	...
	@Override
	public <T> AbstractLuceneValueFieldSearchQueryElementFactory<T, F> queryElementFactory(SearchQueryElementTypeKey<T> key) {
		return (AbstractLuceneValueFieldSearchQueryElementFactory<T, F>) queryElementFactories.get( key );
	}
	...
	public static class Builder<F> {
		...
		private final Map<SearchQueryElementTypeKey<?>, AbstractLuceneValueFieldSearchQueryElementFactory<?, F>>
		...
		public <T> void queryElementFactory(SearchQueryElementTypeKey<T> key,
				AbstractLuceneValueFieldSearchQueryElementFactory<T, F> factory) {
