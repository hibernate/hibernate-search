...
/**
 * A hit extractor used when projecting on the score.
 *
 ...
 */
class ScoreHitExtractor implements HitExtractor<ProjectionHitCollector> {

	private final DocumentReferenceExtractorHelper helper;

	ScoreHitExtractor(DocumentReferenceExtractorHelper helper) {
		this.helper = helper;
	}
