 ...
 */
public class DocumentReferenceProjectionHitExtractor implements HitExtractor<ProjectionHitCollector> {

	private final DocumentReferenceExtractorHelper helper;

	public DocumentReferenceProjectionHitExtractor(DocumentReferenceExtractorHelper helper) {
		this.helper = helper;
	}
