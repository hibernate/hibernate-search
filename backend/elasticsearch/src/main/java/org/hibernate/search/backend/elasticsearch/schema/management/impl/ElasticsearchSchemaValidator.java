...
public interface ElasticsearchSchemaValidator {
	 ...
	 */
	boolean isAliasesValid(IndexMetadata expectedIndexMetadata, IndexMetadata actualIndexMetadata);
	 ...
	 */
	boolean isMappingValid(IndexMetadata expectedIndexMetadata, IndexMetadata actualIndexMetadata);
