 ...
 *
 * @param <T> The type returned by {@link #create(ElasticsearchSearchIndexScope, ElasticsearchSearchValueFieldContext)}.
...
public interface ElasticsearchSearchValueFieldQueryElementFactory<T, F> {
	 ...
	 */
	T create(ElasticsearchSearchIndexScope scope, ElasticsearchSearchValueFieldContext<F> field);
