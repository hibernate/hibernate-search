 ...
 */
public class ElasticsearchIntegerIndexSchemaFieldContext
		extends AbstractElasticsearchScalarFieldTypedContext<ElasticsearchIntegerIndexSchemaFieldContext, Integer> {

	private final String relativeFieldName;

	public ElasticsearchIntegerIndexSchemaFieldContext(IndexSchemaContext schemaContext, String relativeFieldName) {
	...
	@Override
	protected ElasticsearchIntegerIndexSchemaFieldContext thisAsS() {
		return this;
	}
}
