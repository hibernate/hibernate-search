...
public abstract class AbstractElasticsearchMultiIndexSearchIndexSchemaElementContext<E extends ElasticsearchSearchIndexSchemaElementContext>
		implements ElasticsearchSearchIndexSchemaElementContext {
	...
	public AbstractElasticsearchMultiIndexSearchIndexSchemaElementContext(ElasticsearchSearchIndexScope scope,
	...
	public final List<String> nestedPathHierarchy() {
		return getFromElementIfCompatible( ElasticsearchSearchIndexSchemaElementContext::nestedPathHierarchy,
	...
	public final <T> ElasticsearchSearchQueryElementFactory<T, E> queryElementFactory(SearchQueryElementTypeKey<T> key) {
		ElasticsearchSearchQueryElementFactory<T, E> factory = null;
		for ( E indexElement : elementForEachIndex ) {
			ElasticsearchSearchQueryElementFactory<T, E> factoryForIndexElement =
	...
	@Override
	public final <T> T queryElement(SearchQueryElementTypeKey<T> key, ElasticsearchSearchIndexScope scope) {
		ElasticsearchSearchQueryElementFactory<T, E> factory = queryElementFactory( key );
		if ( factory == null ) {
	...
	protected abstract <T> ElasticsearchSearchQueryElementFactory<T, E> queryElementFactory(E indexElement,
	...
	private <T> void checkFactoryCompatibility(SearchQueryElementTypeKey<T> key,
			ElasticsearchSearchQueryElementFactory<T, E> factory1,
			ElasticsearchSearchQueryElementFactory<T, E> factory2) {
