...
public final class ElasticsearchIndexSettings {
	 ...
	 * The file is supposed to contain the full mapping definition for the given index.
	 * <p>
	 * Note that the mappings generated by Hibernate Search will be completely overridden in any case if this property is defined.
	 * <p>
	 * Defaults to no value. Because by default index mappings are generated by Hibernate Search.
	 */
	public static final String SCHEMA_MANAGEMENT_MAPPINGS_FILE = "schema_management.mappings_file";
