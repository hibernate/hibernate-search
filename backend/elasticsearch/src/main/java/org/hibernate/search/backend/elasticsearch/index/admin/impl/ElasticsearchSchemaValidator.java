...
public interface ElasticsearchSchemaValidator {
	 ...
	 */
	void validate(IndexMetadata expectedIndexMetadata, ContextualFailureCollector failureCollector);
	 ...
	 */
	boolean isSettingsValid(IndexMetadata expectedIndexMetadata);
