...
class ElasticsearchBigIntegerIndexFieldTypeContext
		extends AbstractElasticsearchScalarFieldTypeContext<ElasticsearchBigIntegerIndexFieldTypeContext, BigInteger>
		implements ScaledNumberIndexFieldTypeContext<ElasticsearchBigIntegerIndexFieldTypeContext, BigInteger> {
	...
	ElasticsearchBigIntegerIndexFieldTypeContext(ElasticsearchIndexFieldTypeBuildContext buildContext, IndexFieldTypeDefaultsProvider defaultsProvider) {
		super( buildContext, BigInteger.class, DataType.SCALED_FLOAT );
		this.defaultsProvider = defaultsProvider;
	}

	@Override
	public ElasticsearchBigIntegerIndexFieldTypeContext decimalScale(int decimalScale) {
	...
	@Override
	protected ElasticsearchBigIntegerIndexFieldTypeContext thisAsS() {
		return this;
	}
