...
public abstract class AbstractElasticsearchMultiIndexSearchIndexNodeContext<E extends ElasticsearchSearchIndexNodeContext>
		implements ElasticsearchSearchIndexNodeContext {
	...
	public AbstractElasticsearchMultiIndexSearchIndexNodeContext(ElasticsearchSearchIndexScope scope,
	...
	public final List<String> nestedPathHierarchy() {
		return getFromElementIfCompatible( ElasticsearchSearchIndexNodeContext::nestedPathHierarchy,
