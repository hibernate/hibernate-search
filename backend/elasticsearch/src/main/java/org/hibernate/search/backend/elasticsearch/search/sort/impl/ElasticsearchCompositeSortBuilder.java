...
public class ElasticsearchCompositeSortBuilder extends AbstractElasticsearchSortBuilder
		implements CompositeSortBuilder {

	private final List<ElasticsearchSearchSort> elements = new ArrayList<>();

	protected ElasticsearchCompositeSortBuilder(ElasticsearchSearchContext searchContext) {
		super( searchContext );
	}
