 ...
 */
public class SourceHitExtractor<F> implements HitExtractor<ProjectionHitCollector> {
	...
	public SourceHitExtractor(String absoluteFieldPath, ElasticsearchFieldConverter converter) {
