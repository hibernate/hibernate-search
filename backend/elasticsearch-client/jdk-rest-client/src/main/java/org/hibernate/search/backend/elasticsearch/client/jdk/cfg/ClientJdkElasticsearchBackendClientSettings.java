...
public final class ClientJdkElasticsearchBackendClientSettings {
	 ...
	 * or a String that can be parsed into such Integer value.
	 * <p>
	 * Defaults to {@link Defaults#EXECUTOR_POOL_SIZE}.
	 */
	public static final String EXECUTOR_POOL_SIZE = "max_connections";
	...
	* It allows overriding other HTTP client settings, such as {@link ElasticsearchBackendSettings#USERNAME} or {@link #EXECUTOR_POOL_SIZE}.
	* <p>
