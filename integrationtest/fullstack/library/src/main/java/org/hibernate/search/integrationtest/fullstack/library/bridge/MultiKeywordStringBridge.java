 ...
 */
package org.hibernate.search.integrationtest.fullstack.library.bridge;
...
public class MultiKeywordStringBridge implements PropertyBridge {
	...
	public static class Builder implements AnnotationBridgeBuilder<PropertyBridge, org.hibernate.search.integrationtest.fullstack.library.bridge.annotation.MultiKeywordStringBridge> {
		private String fieldName;
		private Pattern separatorPattern = Pattern.compile( SEPARATOR_PATTERN_DEFAULT );

		@Override
		public void initialize(org.hibernate.search.integrationtest.fullstack.library.bridge.annotation.MultiKeywordStringBridge annotation) {
