 ...
 */
package org.hibernate.search.integrationtest.fullstack.library.bridge.annotation;
...
@PropertyBridgeMapping(
		builder = @PropertyBridgeAnnotationBuilderReference(
				type = org.hibernate.search.integrationtest.fullstack.library.bridge.MultiKeywordStringBridge.Builder.class
		)
)
...
public @interface MultiKeywordStringBridge {
	...
	String separatorPattern() default
			org.hibernate.search.integrationtest.fullstack.library.bridge.MultiKeywordStringBridge.SEPARATOR_PATTERN_DEFAULT;
