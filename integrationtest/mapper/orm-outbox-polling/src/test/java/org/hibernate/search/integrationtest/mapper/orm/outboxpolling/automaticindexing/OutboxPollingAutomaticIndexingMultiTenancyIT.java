...
public class OutboxPollingAutomaticIndexingMultiTenancyIT {
	...
	public void perTenantEventProcessorConfiguration() {
		...
		OutboxPollingTestUtils.awaitAllAgentsRunningInOneCluster( with( sessionFactory, TENANT_1_ID ), 2 );
		OutboxPollingTestUtils.awaitAllAgentsRunningInOneCluster( with( sessionFactory, TENANT_2_ID ), 2 );
		OutboxPollingTestUtils.awaitAllAgentsRunningInOneCluster( with( sessionFactory, TENANT_3_ID ), 2 );
