...
public class OutboxPollingAutomaticIndexingBackendFailureIT {
	...
	private void setup(int retryDelay) {
		...
		sessionFactory = ormSetupHelper.start()
				...
				.withProperty( "hibernate.search.coordination.agents.event_processor.outbox_event_finder.provider", outboxEventFinder.provider() )
				.withProperty( "hibernate.search.coordination.agents.event_processor.retry_delay", retryDelay )
