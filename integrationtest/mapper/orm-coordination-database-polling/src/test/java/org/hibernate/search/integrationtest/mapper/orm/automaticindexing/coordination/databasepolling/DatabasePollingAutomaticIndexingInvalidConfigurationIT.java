...
public class DatabasePollingAutomaticIndexingInvalidConfigurationIT {
	...
	public void pulseInterval_negative() {
		assertThatThrownBy( () -> setup( context -> context
				.withProperty( "hibernate.search.coordination.processors.indexing.pulse_interval", "-1" ) ) )
				.isInstanceOf( SearchException.class )
				.hasMessageMatching( FailureReportUtils.buildFailureReportPattern()
						.failure( "Invalid value for configuration property 'hibernate.search.coordination.processors.indexing.pulse_interval'",
	...
	public void pulseInterval_zero() {
		assertThatThrownBy( () -> setup( context -> context
				.withProperty( "hibernate.search.coordination.processors.indexing.pulse_interval", "0" ) ) )
				.isInstanceOf( SearchException.class )
				.hasMessageMatching( FailureReportUtils.buildFailureReportPattern()
						.failure( "Invalid value for configuration property 'hibernate.search.coordination.processors.indexing.pulse_interval'",
	...
	public void pulseInterval_lowerThanPollingInterval() {
		assertThatThrownBy( () -> setup( context -> context
				.withProperty( "hibernate.search.coordination.processors.indexing.pulse_interval", "40" )
				.withProperty( "hibernate.search.coordination.processors.indexing.polling_interval", "50" ) ) )
				.isInstanceOf( SearchException.class )
				.hasMessageMatching( FailureReportUtils.buildFailureReportPattern()
						.failure( "Invalid value for configuration property 'hibernate.search.coordination.processors.indexing.pulse_interval'",
	...
	public void pulseExpiration_negative() {
		assertThatThrownBy( () -> setup( context -> context
				.withProperty( "hibernate.search.coordination.processors.indexing.pulse_expiration", "-1" ) ) )
				.isInstanceOf( SearchException.class )
				.hasMessageMatching( FailureReportUtils.buildFailureReportPattern()
						.failure( "Invalid value for configuration property 'hibernate.search.coordination.processors.indexing.pulse_expiration'",
								"'-1'", "'value' must be strictly positive" )
						.build() );
	}
	...
	public void pulseExpiration_zero() {
		assertThatThrownBy( () -> setup( context -> context
				.withProperty( "hibernate.search.coordination.processors.indexing.pulse_expiration", "0" ) ) )
				.isInstanceOf( SearchException.class )
				.hasMessageMatching( FailureReportUtils.buildFailureReportPattern()
						.failure( "Invalid value for configuration property 'hibernate.search.coordination.processors.indexing.pulse_expiration'",
								"'0'", "'value' must be strictly positive" )
	...
	public void pulseExpiration_lowerThan3TimesPollingInterval() {
		assertThatThrownBy( () -> setup( context -> context
				.withProperty( "hibernate.search.coordination.processors.indexing.pulse_expiration", "599" )
				.withProperty( "hibernate.search.coordination.processors.indexing.pulse_interval", "200" ) ) )
				.isInstanceOf( SearchException.class )
				.hasMessageMatching( FailureReportUtils.buildFailureReportPattern()
						.failure( "Invalid value for configuration property 'hibernate.search.coordination.processors.indexing.pulse_expiration'",
								"'599'",
