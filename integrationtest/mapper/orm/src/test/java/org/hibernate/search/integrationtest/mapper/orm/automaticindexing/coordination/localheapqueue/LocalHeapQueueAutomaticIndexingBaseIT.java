 ...
 */
package org.hibernate.search.integrationtest.mapper.orm.automaticindexing.coordination.localheapqueue;
...
/**
 * Tests suite for automatic indexing with {@link LocalHeapQueueCooordinationStrategy}.
 * <p>
 * The main purpose of this test suite is to check that the concept of automatic indexing in a background process can work,
 * but {@link LocalHeapQueueCooordinationStrategy} definitely isn't something we can use in a production environment,
...
public class LocalHeapQueueAutomaticIndexingBaseIT {

	@BeforeClass
	public static void beforeAll() {
		// Force the automatic indexing strategy
		OrmSetupHelper.defaultAutomaticIndexingStrategy( CoordinationStrategyExpectations.localHeapQueue() );
	}
