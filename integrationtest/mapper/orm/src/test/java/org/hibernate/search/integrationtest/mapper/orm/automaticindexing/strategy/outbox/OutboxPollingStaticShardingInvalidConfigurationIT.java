...
public class OutboxPollingStaticShardingInvalidConfigurationIT {
	...
	public void totalCount_missing() {
		assertThatThrownBy( () -> setup( context -> context ) )
				...
				.hasMessageMatching( FailureReportUtils.buildFailureReportPattern()
						.failure( "Invalid value for configuration property 'hibernate.search.automatic_indexing.processing.shards.total_count'",
	...
	public void totalCount_zero() {
		assertThatThrownBy( () -> setup( context -> context
				.withProperty( "hibernate.search.automatic_indexing.processing.shards.total_count", "0" ) ) )
				.isInstanceOf( SearchException.class )
				.hasMessageMatching( FailureReportUtils.buildFailureReportPattern()
						.failure( "Invalid value for configuration property 'hibernate.search.automatic_indexing.processing.shards.total_count'",
	...
	public void totalCount_negative() {
		assertThatThrownBy( () -> setup( context -> context
				.withProperty( "hibernate.search.automatic_indexing.processing.shards.total_count", "-1" ) ) )
				.isInstanceOf( SearchException.class )
				.hasMessageMatching( FailureReportUtils.buildFailureReportPattern()
						.failure( "Invalid value for configuration property 'hibernate.search.automatic_indexing.processing.shards.total_count'",
	...
	public void assigned_missing() {
		assertThatThrownBy( () -> setup( context -> context
				.withProperty( "hibernate.search.automatic_indexing.processing.shards.total_count", "10" ) ) )
				.isInstanceOf( SearchException.class )
				.hasMessageMatching( FailureReportUtils.buildFailureReportPattern()
						.failure( "Invalid value for configuration property 'hibernate.search.automatic_indexing.processing.shards.assigned'",
								"''", "When using static sharding, this property must be set" )
						.build() );
	}
	...
	public void assigned_negative() {
		assertThatThrownBy( () -> setup( context -> context
				.withProperty( "hibernate.search.automatic_indexing.processing.shards.total_count", "10" )
				.withProperty( "hibernate.search.automatic_indexing.processing.shards.assigned", "-1" ) ) )
				.isInstanceOf( SearchException.class )
				.hasMessageMatching( FailureReportUtils.buildFailureReportPattern()
						.failure( "Invalid value for configuration property 'hibernate.search.automatic_indexing.processing.shards.assigned'",
								"'-1'",
								"Shard indices must be between 0 (inclusive) and 10 (exclusive,"
										+ " set by 'hibernate.search.automatic_indexing.processing.shards.total_count')" )
						.build() );
	}
	...
	public void assigned_equalToTotalCount() {
		assertThatThrownBy( () -> setup( context -> context
				.withProperty( "hibernate.search.automatic_indexing.processing.shards.total_count", "10" )
				.withProperty( "hibernate.search.automatic_indexing.processing.shards.assigned", "10" ) ) )
				.isInstanceOf( SearchException.class )
				.hasMessageMatching( FailureReportUtils.buildFailureReportPattern()
						.failure( "Invalid value for configuration property 'hibernate.search.automatic_indexing.processing.shards.assigned'",
								"'10'",
	...
	public void assigned_greaterThanTotalCount() {
		assertThatThrownBy( () -> setup( context -> context
				.withProperty( "hibernate.search.automatic_indexing.processing.shards.total_count", "10" )
				.withProperty( "hibernate.search.automatic_indexing.processing.shards.assigned", "11" ) ) )
				.isInstanceOf( SearchException.class )
				.hasMessageMatching( FailureReportUtils.buildFailureReportPattern()
						.failure( "Invalid value for configuration property 'hibernate.search.automatic_indexing.processing.shards.assigned'",
								"'11'",
	...
	private void setup(UnaryOperator<OrmSetupHelper.SetupContext> config) {
		...
		ormSetupHelper.start()
				.withProperty( "hibernate.search.automatic_indexing.processing.shards.static", "true" )
				.with( config )
