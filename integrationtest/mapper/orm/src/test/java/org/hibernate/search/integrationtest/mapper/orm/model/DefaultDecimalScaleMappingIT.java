...
public class DefaultDecimalScaleMappingIT {
	...
	public static final class IndexedEntity {
		...
		@ScaledNumberField
		@Column(precision = 14)
		// if precision attribute is set, the default column scale is 0
		private BigDecimal unscaled;

		@ScaledNumberField
		// without precision, the default column scale depends on SQL database underlying mapping
		...
		@GenericField
		// decimal scale value provided by Hibernate ORM
		// is not used if the field is not a decimal-number field
		@Column(precision = 14, scale = 3)
		private Integer notDecimal;

		@GenericField
		// decimal scale value provided by Hibernate ORM
		// is used even if we use a @GenericField to annotate the field
		@Column(precision = 14, scale = 3)
