...
/**
 * Base tests for static sharding with the outbox-polling strategy:
...
public class OutboxPollingStaticShardingBaseIT {
	...
	private SessionFactory setup(Action action, int assignedShardIndex) {
		...
		return ormSetupHelper.start()
				...
				.withProperty( "hibernate.search.automatic_indexing.processing.shards.total_count", totalShardCount )
				.withProperty( "hibernate.search.automatic_indexing.processing.shards.assigned", String.valueOf( assignedShardIndex ) )
