...
/**
 * Test basic Hibernate Search configuration (RAM directory provider), deployed on an application server as an EAR and
 * using the jboss deployment descriptor (jboss-depoloyment-structure.xml) to include the required dependencies via JBoss
 * Modules.
 *
