...
import org.hibernate.search.integrationtest.showcase.library.service.JavaRecordService;
...
class JavaRecordIT extends AbstractLibraryShowcaseSearchIT {
	...
	@Autowired
	private JavaRecordService javaRecordService;
	...
	void searchAndProject() {
		List<LibrarySimpleProjectionRecord> libraries = javaRecordService.searchAndProjectToRecord( "library", 0, 10 );
		...
		libraries = javaRecordService.searchAndProjectToRecord( "library", 1, 2 );
		assertThat( libraries ).extracting( LibrarySimpleProjectionRecord::name ).containsExactly(
				libraryService.getById( UNIVERSITY_ID, Library::getName ),
				libraryService.getById( SUBURBAN_1_ID, Library::getName ) );
		assertThat( libraries ).extracting( LibrarySimpleProjectionRecord::services ).containsExactly(
		...
		libraries = javaRecordService.searchAndProjectToRecord( "sUburban", 0, 10 );
		assertThat( libraries ).extracting( LibrarySimpleProjectionRecord::name ).containsExactly(
				libraryService.getById( SUBURBAN_1_ID, Library::getName ),
				libraryService.getById( SUBURBAN_2_ID, Library::getName ) );
		assertThat( libraries ).extracting( LibrarySimpleProjectionRecord::services ).containsExactly(
	...
	void searchAndProjectToMethodLocalClass() {
		List<LibrarySimpleProjectionRecord> libraries =
				javaRecordService.searchAndProjectToMethodLocalRecord( "library", 0, 10 );
		assertThat( libraries ).extracting( LibrarySimpleProjectionRecord::name ).containsExactly(
				libraryService.getById( CITY_CENTER_ID, Library::getName ),
				libraryService.getById( UNIVERSITY_ID, Library::getName ),
				libraryService.getById( SUBURBAN_1_ID, Library::getName ),
		...
		libraries = javaRecordService.searchAndProjectToMethodLocalRecord( "library", 1, 2 );
		assertThat( libraries ).extracting( LibrarySimpleProjectionRecord::name ).containsExactly(
				libraryService.getById( UNIVERSITY_ID, Library::getName ),
				libraryService.getById( SUBURBAN_1_ID, Library::getName ) );
		assertThat( libraries ).extracting( LibrarySimpleProjectionRecord::services ).containsExactly(
		...
		libraries = javaRecordService.searchAndProjectToMethodLocalRecord( "sUburban", 0, 10 );
		assertThat( libraries ).extracting( LibrarySimpleProjectionRecord::name ).containsExactly(
				libraryService.getById( SUBURBAN_1_ID, Library::getName ),
				libraryService.getById( SUBURBAN_2_ID, Library::getName ) );
		assertThat( libraries ).extracting( LibrarySimpleProjectionRecord::services ).containsExactly(
