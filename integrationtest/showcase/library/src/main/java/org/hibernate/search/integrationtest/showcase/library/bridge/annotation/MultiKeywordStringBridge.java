...
@PropertyBinding(bridge = @PropertyBridgeRef(binderType = org.hibernate.search.integrationtest.showcase.library.bridge.MultiKeywordStringBridge.Binder.class))
