...
public class FieldProjectionTypeCheckingAndConversionIT<F> {
	...
	public void multiValuedField_singleValuedProjection(FieldTypeDescriptor<F> fieldType) {
		StubMappingScope scope = mainIndex.createScope();
	...
	@MethodSource("params")
	@TestForIssue(jiraKey = "HSEARCH-3391")
	public void singleValuedFieldInMultiValuedObjectField_flattened_singleValuedProjection(FieldTypeDescriptor<F> fieldType) {
	...
	@MethodSource("params")
	@TestForIssue(jiraKey = "HSEARCH-3391")
	public void singleValuedFieldInMultiValuedObjectField_nested_singleValuedProjection(FieldTypeDescriptor<F> fieldType) {
	...
	public void multiIndex_withMissingFieldIndex_projectionConverterEnabled(FieldTypeDescriptor<F> fieldType) {
	...
	@MethodSource("params")
	@TestForIssue(jiraKey = "HSEARCH-4173")
	public void multiIndex_withMissingFieldIndex_projectionConverterDisabled(FieldTypeDescriptor<F> fieldType) {
		StubMappingScope scope = mainIndex.createScope( missingFieldIndex );
