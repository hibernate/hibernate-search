...
public class FieldSortBaseIT<F> {
	...
	public void medianWithNestedField(TestedFieldStructure fieldStructure,
			FieldTypeDescriptor<F> fieldType, SortMode sortMode,
			DataSet<F> dataSetForAsc, DataSet<F> dataSetForDesc) {
		assumeTrue(
	...
	@MethodSource("params")
	@TestForIssue(jiraKey = { "HSEARCH-3103" })
	public void sumOrAvgOrMedianWithStringField(TestedFieldStructure fieldStructure,
			FieldTypeDescriptor<F> fieldType, SortMode sortMode,
			DataSet<F> dataSetForAsc, DataSet<F> dataSetForDesc) {
		assumeTrue(
	...
	@MethodSource("params")
	@TestForIssue(jiraKey = { "HSEARCH-3103" })
	public void sumWithTemporalField(TestedFieldStructure fieldStructure,
			FieldTypeDescriptor<F> fieldType, SortMode sortMode,
			DataSet<F> dataSetForAsc, DataSet<F> dataSetForDesc) {
		assumeTrue(
	...
	public void missingValue_default(TestedFieldStructure fieldStructure,
			FieldTypeDescriptor<F> fieldType, SortMode sortMode,
			DataSet<F> dataSetForAsc, DataSet<F> dataSetForDesc) {
		assumeTestParametersWork( fieldStructure, fieldType, sortMode );
	...
	public void missingValue_explicit_multipleEmpty(TestedFieldStructure fieldStructure,
			FieldTypeDescriptor<F> fieldType, SortMode sortMode,
			DataSet<F> dataSetForAsc, DataSet<F> dataSetForDesc) {
		assumeTestParametersWork( fieldStructure, fieldType, sortMode );
	...
	@MethodSource("params")
	@TestForIssue(jiraKey = "HSEARCH-3254")
	public void missingValue_multipleEmpty_useExistingDocumentValue(TestedFieldStructure fieldStructure,
			FieldTypeDescriptor<F> fieldType, SortMode sortMode,
			DataSet<F> dataSetForAsc, DataSet<F> dataSetForDesc) {
		assumeTestParametersWork( fieldStructure, fieldType, sortMode );
	...
	public void concurrentQueriesUsingSameSort(TestedFieldStructure fieldStructure,
			FieldTypeDescriptor<F> fieldType, SortMode sortMode,
			DataSet<F> dataSetForAsc, DataSet<F> dataSetForDesc) {
		assumeTestParametersWork( fieldStructure, fieldType, sortMode );
