...
public class SingleFieldAggregationBaseIT<F> {
	...
	public void simple(SupportedSingleFieldAggregationExpectations<F> expectations,
		...
		testValidAggregation( getSimpleScenario( expectations, fieldStructure ), mainIndex.createScope(),
				getFieldPath( mainIndex.binding(), fieldStructure, expectations.fieldType() ), getFilterOrNull( mainIndex.binding(),
						fieldStructure
				), dataSet
		);
	}
	...
	public void noMatch(SupportedSingleFieldAggregationExpectations<F> expectations,
			TestedFieldStructure fieldStructure, DataSet<F> dataSet) {
	...
	public void emptyIndex(SupportedSingleFieldAggregationExpectations<F> expectations,
			TestedFieldStructure fieldStructure, DataSet<F> dataSet) {
	...
	public void nullOnlyIndex(SupportedSingleFieldAggregationExpectations<F> expectations,
			TestedFieldStructure fieldStructure, DataSet<F> dataSet) {
	...
	public void factoryWithRoot(SupportedSingleFieldAggregationExpectations<F> expectations,
			TestedFieldStructure fieldStructure, DataSet<F> dataSet) {
