...
public class SimpleQueryStringPredicateBaseIT {
	...
	public static class SingleFieldIT extends AbstractPredicateSingleFieldIT<SimpleQueryStringPredicateTestValues> {
		...
		public SingleFieldIT(DataSet<String, SimpleQueryStringPredicateTestValues> dataSet) {
			super( index, dataSet );
		}
	...
	public static class MultiFieldIT extends AbstractPredicateMultiFieldIT<SimpleQueryStringPredicateTestValues> {
		...
		public MultiFieldIT(DataSet<String, SimpleQueryStringPredicateTestValues> dataSet) {
			super( index, dataSet );
		}
	...
	@RunWith(Parameterized.class)
	public static class NestingIT extends AbstractPredicateFieldNestingIT<SimpleQueryStringPredicateTestValues> {
		...
		public NestingIT(DataSet<String, SimpleQueryStringPredicateTestValues> dataSet) {
			super( index, dataSet );
		}
	...
	public static class ScoreIT extends AbstractPredicateFieldScoreIT<SimpleQueryStringPredicateTestValues> {
		...
		public ScoreIT(DataSet<String, SimpleQueryStringPredicateTestValues> dataSet) {
			super( index, dataSet );
		}
