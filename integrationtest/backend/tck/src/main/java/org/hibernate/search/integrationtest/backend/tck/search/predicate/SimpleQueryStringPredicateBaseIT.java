	...
	public static class ScoreIT extends AbstractPredicateFieldScoreIT<SimpleQueryStringPredicateTestValues> {
		...
		protected PredicateFinalStep predicate(SearchPredicateFactory f, String fieldPath, int matchingDocOrdinal,
			...
			return f.simpleQueryString().field( fieldPath )
					.matching( ( (DataSet<?, SimpleQueryStringPredicateTestValues>) dataSet ).values.matchingArg( matchingDocOrdinal ) );
		}
		...
		protected PredicateFinalStep predicateWithConstantScore(SearchPredicateFactory f, String[] fieldPaths,
			...
			return f.simpleQueryString().fields( fieldPaths )
					.matching( ( (DataSet<?, SimpleQueryStringPredicateTestValues>) dataSet ).values.matchingArg( matchingDocOrdinal ) ).constantScore();
		}
		...
		protected PredicateFinalStep predicateWithPredicateLevelBoost(SearchPredicateFactory f, String[] fieldPaths,
			...
			return f.simpleQueryString().fields( fieldPaths )
					.matching( ( (DataSet<?, SimpleQueryStringPredicateTestValues>) dataSet ).values.matchingArg( matchingDocOrdinal ) ).boost( predicateBoost );
		}
		...
		protected PredicateFinalStep predicateWithConstantScoreAndPredicateLevelBoost(SearchPredicateFactory f,
				...
				DataSet<?, SimpleQueryStringPredicateTestValues> dataSet) {
			return f.simpleQueryString().fields( fieldPaths )
					.matching( ( (DataSet<?, SimpleQueryStringPredicateTestValues>) dataSet ).values.matchingArg( matchingDocOrdinal ) ).constantScore().boost( predicateBoost );
		}
		...
		protected PredicateFinalStep predicateWithFieldLevelBoostAndConstantScore(SearchPredicateFactory f,
				String fieldPath, float fieldBoost, int matchingDocOrdinal, DataSet<?, SimpleQueryStringPredicateTestValues> dataSet) {
			return f.simpleQueryString().field( fieldPath ).boost( fieldBoost )
					.matching( ( (DataSet<?, SimpleQueryStringPredicateTestValues>) dataSet ).values.matchingArg( matchingDocOrdinal ) ).constantScore();
		}
