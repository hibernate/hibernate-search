...
public class AnalysisBuiltinIT {
	...
	public static List<? extends Arguments> params() {
		return Arrays.asList(
				...
				Arguments.of( (Function<TckBackendHelper, TckBackendSetupStrategy<?>>) TckBackendHelper::createAnalysisNotConfiguredBackendSetupStrategy ),
				// Test with an analysis configurer that does not override the defaults but defines other analyzers
				Arguments.of( (Function<TckBackendHelper, TckBackendSetupStrategy<?>>) TckBackendHelper::createAnalysisCustomBackendSetupStrategy )
		);
	}
