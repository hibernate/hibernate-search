...
class WildcardPredicateBaseIT {
	...
	@Nested
	class SingleFieldIT extends AbstractPredicateSingleFieldIT<WildcardPredicateTestValues> {
	...
	@Nested
	class MultiFieldIT extends AbstractPredicateMultiFieldIT<WildcardPredicateTestValues> {
		private static final SimpleMappedIndex<IndexBinding> index =
				SimpleMappedIndex.of( root -> new IndexBinding( root, supportedFieldTypes ) )
						.name( "multiField" );
	...
	@Nested
	class InObjectFieldIT extends AbstractPredicateFieldInObjectFieldIT<WildcardPredicateTestValues> {
	...
	@Nested
	class ScoreIT extends AbstractPredicateFieldScoreIT<WildcardPredicateTestValues> {
		private static final SimpleMappedIndex<IndexBinding> index =
				SimpleMappedIndex.of( root -> new IndexBinding( root, supportedFieldTypes ) )
						.name( "score" );
