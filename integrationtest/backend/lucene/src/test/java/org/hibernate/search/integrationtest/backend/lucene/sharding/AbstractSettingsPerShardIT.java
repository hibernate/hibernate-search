...
public abstract class AbstractSettingsPerShardIT {
	...
	public static List<? extends Arguments> params() {
		...
		return Arrays.asList(
				Arguments.of( "hash",
						(Function<TckBackendHelper, TckBackendSetupStrategy<?>>)( helper -> helper.createHashBasedShardingBackendSetupStrategy( 4 ) ),
						new ArrayList<>( hashShardIds )
				),
				Arguments.of(
						"explicit",
						(Function<TckBackendHelper, TckBackendSetupStrategy<?>>)( ignored -> ShardingExplicitIT.explicitShardingBackendSetupStrategy(
								explicitShardIds ) ),
	...
	protected void init(String strategy, Function<TckBackendHelper, TckBackendSetupStrategy<?>> setupStrategyFunction, List<String> shardIds) {
