...
public class LuceneMultiValueSearchPredicateMasterIT {
	...
	public LuceneMultiValueSearchPredicateMasterIT(String directoryType) {
	...
	public void double_searchParentMultivalues() {
		...
		SearchQuery<DocumentReference> query = scope.query()
			.where( f -> f.matchAll() )
			.sort( f -> f.field( "additionalDoubleField" )
	...
	public void float_searchParentMultivalues() {
		...
		SearchQuery<DocumentReference> query = scope.query()
			.where( f -> f.matchAll() )
			.sort( f -> f.field( "additionalFloatField" )
			.asc().multi( SortMultiValue.MIN ) )
			.toQuery();
	...
	public void long_searchParentMultivalues() {
		...
		SearchQuery<DocumentReference> query = scope.query()
			.where( f -> f.matchAll() )
			.sort( f -> f.field( "additionalLongField" )
			.asc().multi( SortMultiValue.MIN ) )
			.toQuery();
	...
	public void integer_searchParentMultivalues() {
		...
		SearchQuery<DocumentReference> query = scope.query()
			.where( f -> f.matchAll() )
			.sort( f -> f.field( "additionalIntegerField" )
			.asc().multi( SortMultiValue.MIN ) )
			.toQuery();
