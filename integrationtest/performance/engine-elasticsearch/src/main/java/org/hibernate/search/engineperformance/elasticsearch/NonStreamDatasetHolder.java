...
public class NonStreamDatasetHolder extends BaseDataSetup {
	...
	@Setup
	public void initializeState(NonStreamWriteEngineHolder eh) throws IOException, URISyntaxException {
