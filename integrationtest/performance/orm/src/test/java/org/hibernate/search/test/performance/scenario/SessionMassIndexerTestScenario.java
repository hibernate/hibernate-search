...
import org.hibernate.search.test.performance.task.SessionMassIndexerTask;

/**
 * @author Yoann Rodiere
 */
public abstract class SessionMassIndexerTestScenario extends AbstractTestScenario {
	...
	protected void addTasks(TestScenarioContext ctx) {
		...
		new SessionMassIndexerTask( ctx );
