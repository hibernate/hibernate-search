...
public class JGroupsBackendQueueProcessor implements BackendQueueProcessor {
	...
	public void initialize(Properties props, WorkerBuildContext context, DirectoryBasedIndexManager indexManager) {
		...
		final long messageTimeout = ConfigurationParseHelper.getLongValue( props, MESSAGE_TIMEOUT_MS, DEFAULT_MESSAGE_TIMEOUT );
		...
		String backend = props.getProperty( DELEGATE_BACKEND );
