...
/**
 * Each entry ({@code null included}) of an {@link Iterable} object is indexed using the specified
 * {@link FieldBridge}.
 * <br>
 * A {@code null} {@link Iterable} object is not indexed.
 *
...
public class IterableBridge implements FieldBridge, ContainerBridge {
	...
	/**
	 * @param bridge the {@link FieldBridge} used for each entry of the {@link Iterable} object.
	 */
