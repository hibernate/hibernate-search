 ...
 *
 * The recommended approach to index is to use {@link #addFieldToDocument(String, String, Document)}
 * or {@link #addNumericFieldToDocument(String, Object, Document)} as all the options declared by
...
public interface LuceneOptions {
	...
	/**
	 * Prefer the use of {@link #addFieldToDocument(String, String, Document)}
