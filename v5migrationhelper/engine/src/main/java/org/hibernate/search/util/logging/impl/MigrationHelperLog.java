...
public interface MigrationHelperLog extends BaseHibernateSearchLogger {

	String CATEGORY_NAME = "org.hibernate.search.migration";

	MigrationHelperLog INSTANCE = LoggerFactory.make( MigrationHelperLog.class, CATEGORY_NAME, MethodHandles.lookup() );
