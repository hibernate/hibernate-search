 ...
 *<p>
 * Multiple threads produce one or more {@link LuceneWork}
 * by calling {@link #submit(List, IndexingMonitor)},
 * and get blocked until their changes are applied to the index;</p>
 * The {@link Consumer} thread will
...
final class SyncWorkProcessor implements WorkProcessor {
	 ...
	 * @param resources new instance of {@link LuceneBackendResources}
	 */
	@Override
