...
public class MultiValuedFacetingTest {
	...
	public void stringArray() throws Exception {
		...
		HSQuery hsQuery = sfHolder.getSearchFactory().createHSQuery()
				.luceneQuery( new MatchAllDocsQuery() )
				.targetedEntities( Arrays.<Class<?>>asList( StringArrayFacetEntity.class ) );
	...
	public void stringCollection() throws Exception {
		...
		HSQuery hsQuery = sfHolder.getSearchFactory().createHSQuery()
				.luceneQuery( new MatchAllDocsQuery() )
				.targetedEntities( Arrays.<Class<?>>asList( StringCollectionFacetEntity.class ) );
	...
	public void stringMap() throws Exception {
		...
		HSQuery hsQuery = sfHolder.getSearchFactory().createHSQuery()
				.luceneQuery( new MatchAllDocsQuery() )
				.targetedEntities( Arrays.<Class<?>>asList( StringMapFacetEntity.class ) );
	...
	public void numberArray() throws Exception {
		...
		HSQuery hsQuery = sfHolder.getSearchFactory().createHSQuery()
				.luceneQuery( new MatchAllDocsQuery() )
				.targetedEntities( Arrays.<Class<?>>asList( NumberArrayFacetEntity.class ) );
	...
	public void numberCollection() throws Exception {
		...
		HSQuery hsQuery = sfHolder.getSearchFactory().createHSQuery()
				.luceneQuery( new MatchAllDocsQuery() )
				.targetedEntities( Arrays.<Class<?>>asList( NumberCollectionFacetEntity.class ) );
	...
	public void numberMap() throws Exception {
		...
		HSQuery hsQuery = sfHolder.getSearchFactory().createHSQuery()
				.luceneQuery( new MatchAllDocsQuery() )
				.targetedEntities( Arrays.<Class<?>>asList( NumberMapFacetEntity.class ) );
