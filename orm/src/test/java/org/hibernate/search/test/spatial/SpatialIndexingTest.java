...
public class SpatialIndexingTest extends SearchTestBase {
	...
	public void testSpatialAnnotationOnFieldLevel() throws Exception {
		...
		org.apache.lucene.search.Query luceneQuery2 = builder.spatial().againstField( "location" )
	...
	public void testSpatialAnnotationWithSubAnnotationsLevel() throws Exception {
		...
		org.apache.lucene.search.Query luceneQuery = builder.spatial().againstField( "home" )
				.within( 50, Unit.KM ).ofLatitude( centerLatitude ).andLongitude( centerLongitude ).createQuery();
		...
		org.apache.lucene.search.Query luceneQuery2 = builder.spatial().againstField( "home" )
				.within( 51, Unit.KM ).ofLatitude( centerLatitude ).andLongitude( centerLongitude ).createQuery();
	...
	public void testSpatialsAnnotation() throws Exception {
		...
		org.apache.lucene.search.Query luceneQuery2 = builder.spatial().againstField( "work" )
	...
	public void testSpatialAnnotationOnClassLevel() throws Exception {
		...
		org.apache.lucene.search.Query luceneQuery = builder.spatial().againstField( "hotel_location" )
				.within( 50, Unit.KM ).ofLatitude( centerLatitude ).andLongitude( centerLongitude ).createQuery();
		...
		org.apache.lucene.search.Query luceneQuery2 = builder.spatial().againstField( "hotel_location" )
				.within( 51, Unit.KM ).ofLatitude( centerLatitude ).andLongitude( centerLongitude ).createQuery();
	...
	public void testSpatialAnnotationOnEmbeddableFieldLevel() throws Exception {
		...
		org.apache.lucene.search.Query luceneQuery = builder.spatial().againstField( "position.location" )
				.within( 50, Unit.KM ).ofLatitude( centerLatitude ).andLongitude( centerLongitude ).createQuery();
		...
		org.apache.lucene.search.Query luceneQuery2 = builder.spatial().againstField( "position.location" )
				.within( 51, Unit.KM ).ofLatitude( centerLatitude ).andLongitude( centerLongitude ).createQuery();
