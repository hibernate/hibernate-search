...
public class ProjectionQueryTest extends SearchTestCase {
	...
	public void testProjectionOfThisAndEAGERFetching() throws Exception {
		...
		assertFieldSelectorEnabled( "id" );//don't use the Projection constants but the actual field name being used to encode the Id
	...
	public void testResultTransformToDelimString() throws Exception {
		...
		assertFieldSelectorEnabled( "lastname", "dept", "id" ); //don't use the Projection constants but the actual field name being used to encode the Id
