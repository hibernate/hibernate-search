 ...
 */
package org.hibernate.search.batch.jsr352.massindexing.impl;

import static org.hibernate.search.batch.jsr352.massindexing.MassIndexingJobParameters.CACHE_MODE;
import static org.hibernate.search.batch.jsr352.massindexing.MassIndexingJobParameters.CHECKPOINT_INTERVAL;
import static org.hibernate.search.batch.jsr352.massindexing.MassIndexingJobParameters.CUSTOM_QUERY_CRITERIA;
import static org.hibernate.search.batch.jsr352.massindexing.MassIndexingJobParameters.CUSTOM_QUERY_HQL;
import static org.hibernate.search.batch.jsr352.massindexing.MassIndexingJobParameters.ENTITY_FETCH_SIZE;
import static org.hibernate.search.batch.jsr352.massindexing.MassIndexingJobParameters.ENTITY_MANAGER_FACTORY_NAMESPACE;
import static org.hibernate.search.batch.jsr352.massindexing.MassIndexingJobParameters.ENTITY_MANAGER_FACTORY_REFERENCE;
import static org.hibernate.search.batch.jsr352.massindexing.MassIndexingJobParameters.ENTITY_TYPES;
import static org.hibernate.search.batch.jsr352.massindexing.MassIndexingJobParameters.ID_FETCH_SIZE;
import static org.hibernate.search.batch.jsr352.massindexing.MassIndexingJobParameters.MAX_RESULTS_PER_ENTITY;
import static org.hibernate.search.batch.jsr352.massindexing.MassIndexingJobParameters.MAX_THREADS;
import static org.hibernate.search.batch.jsr352.massindexing.MassIndexingJobParameters.OPTIMIZE_AFTER_PURGE;
import static org.hibernate.search.batch.jsr352.massindexing.MassIndexingJobParameters.OPTIMIZE_ON_FINISH;
import static org.hibernate.search.batch.jsr352.massindexing.MassIndexingJobParameters.PURGE_ALL_ON_START;
import static org.hibernate.search.batch.jsr352.massindexing.MassIndexingJobParameters.ROWS_PER_PARTITION;
import static org.hibernate.search.batch.jsr352.massindexing.MassIndexingJobParameters.SESSION_CLEAR_INTERVAL;
...
import org.hibernate.search.batch.jsr352.massindexing.impl.util.JobContextUtil;
