...
class FieldReferenceIT {
	...
	public static class ValueFieldReference2<E, T, V> extends TypedFieldReference2<E, T> {
		...
		public ValueFieldReference2(String absolutePath, Class<E> containing, Class<T> inputType, Class<V> indexType) {
			super( absolutePath, ValueConvert.YES, containing, inputType );
			this.noConverter = new TypedFieldReference2<>( absolutePath, ValueConvert.NO, containing, indexType );
			this.string =
					new TypedFieldReference2<>( absolutePath, ValueConvert.PARSE, containing, String.class );
		}
	...
	public static class TypedFieldReference2<SR, T>
		...
		public TypedFieldReference2(String absolutePath, ValueConvert valueConvert, Class<SR> containing, Class<T> input) {
			this.absolutePath = absolutePath;
			this.valueConvert = valueConvert;
			this.containing = containing;
			this.input = input;
