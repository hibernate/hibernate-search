...
public class Book {
	...
	@GenericField(valueBinder = @ValueBinderRef(type = BooleanAsStringBinder.class, // <1>
			params = {
					@Parameter(name = "trueAsString", value = "yes"),
					@Parameter(name = "falseAsString", value = "no")
			}))
	...
	@GenericField(valueBinder = @ValueBinderRef(type = BooleanAsStringBinder.class, // <2>
			params = {
					@Parameter(name = "trueAsString", value = "passed"),
					@Parameter(name = "falseAsString", value = "failed")
