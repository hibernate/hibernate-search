...
|hibernate.search.[default\|<indexname>].index_flush_interval|Defines the interval in milliseconds that updates will 
be flushed to the index storage. Ignored unless `worker.execution` is configured as `async`.
|`1000`
...
<jboss-deployment-structure>
    <deployment>
        <dependencies>
            <module name="org.hibernate.search.orm" slot="{hibernateSearchVersion}" services="export" />
        </dependencies>
    </deployment>
</jboss-deployment-structure>
====
