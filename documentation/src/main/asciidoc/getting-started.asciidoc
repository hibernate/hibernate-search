...
version included in WildFly - you will also need to follow the instructions in the http://docs.jboss.org/hibernate/orm/{hibernateShortVersion}/topical/html_single/wildfly/Wildfly.html[Hibernate ORM WildFly upgrade guide].
