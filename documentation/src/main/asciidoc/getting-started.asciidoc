...
You can find out more about `@*Field` annotations in <<mapper-pojo-field>>.
...
IMPORTANT: The mass indexer is not yet available in Hibernate Search {hibernateSearchVersion}.
We will add an example here when it is implemented.
See https://hibernate.atlassian.net/browse/HSEARCH-3268[HSEARCH-3268].
