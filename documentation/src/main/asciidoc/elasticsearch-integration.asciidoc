...
|`VALIDATE`|Existing indexes and mappings will be checked for conflicts with Hibernate Search's metamodel.
...
We are working on improving these aspects: https://hibernate.atlassian.net/browse/HSEARCH-2519[HSEARCH-2519],
