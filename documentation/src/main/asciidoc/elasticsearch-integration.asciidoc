...
there is no support for the `MERGE` <<elasticsearch-schema-management-strategy,schema management strategy>>.

We are working on improving this aspect: https://hibernate.atlassian.net/browse/HSEARCH-2520[HSEARCH-2520].
====
