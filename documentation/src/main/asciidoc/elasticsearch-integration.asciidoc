...
[WARNING]
--
Due to https://hibernate.atlassian.net/browse/HSEARCH-2605[HSEARCH-2605],
if you use the `VALIDATE` or `MERGE` schema management strategy
and upgrade your cluster from 2.x to 5.x,
