...
* you can only refer analyzers the are already registered on Elasticsearch, see <<elasticsearch-mapping-analyzer>>
...
built-in or custom analyzers registerd on your Elasticsearch instances.
