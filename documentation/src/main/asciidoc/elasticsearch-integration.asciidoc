...
If you use Amazon's proprietary IAM authentication mechanism to access Elasticsearch,
...
Amazon's proprietary IAM authentication <<elasticsearch-integration-dependencies,requires additional dependencies>>.
...
See https://www.elastic.co/guide/en/elasticsearch/reference/current/dynamic-mapping.html[the reference documentation]
