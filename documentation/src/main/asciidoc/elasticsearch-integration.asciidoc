...
public class Tweet {
    ...
    @Field(analyzer = @Analyzer(definition = "english")) // Elasticsearch built-in analyzer
    private String englishTweet;

    @Field(analyzer = @Analyzer(definition = "whitespace")) // Elasticsearch built-in analyzer
...
[WARNING]
====
Support for `@Analyzer.impl`/`@Normalizer.impl` is deprecated,
and will be removed in Hibernate Search 6.

Use `@Analyzer.definition` instead, as explained above.
====
...
public class Tweet {
    ...
    @Field(analyzer = @Analyzer(impl = EnglishAnalyzer.class)) // Elasticsearch built-in "english" analyzer
    private String englishTweet;

    @Field(analyzer = @Analyzer(impl = WhitespaceAnalyzer.class)) // Elasticsearch built-in "whitespace" analyzer
    private String whitespaceTweet;
...
public class Tweet {
    ...
    @Field(analyzer = @Analyzer(definition = "tweet_analyzer"))
