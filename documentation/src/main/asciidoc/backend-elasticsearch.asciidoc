...
hibernate.search.indexes.<index name>.lifecycle.required_status green (default)
hibernate.search.indexes.<index name>.lifecycle.required_status_wait_timeout 10000 (default)
# OR
hibernate.search.backends.<backend name>.index_defaults.lifecycle.strategy create (default)
hibernate.search.backends.<backend name>.index_defaults.lifecycle.required_status green (default)
hibernate.search.backends.<backend name>.index_defaults.lifecycle.required_status_wait_timeout 10000 (default)
----

The properties `required_status` and `required_status_wait_timeout` define
