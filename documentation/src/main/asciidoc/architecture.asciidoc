...
However while they process the read operation on their local index copy they will delegate the update
...
By default this backend's transactional capabilities are not enabled, but messages will be
