...
|`true`
|Whether the mass indexer should be optimized at the beginning of the job. This operation
takes place after the purge operation and before indexing.

|`optimizeOnFinish(boolean)`
|`true`
|Whether the mass indexer should be optimized at the end of the job. This operation takes
