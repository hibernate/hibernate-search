...
It is applied to a property using a <<mapper-orm-directfieldmapping-annotations,`@*Field` annotation>>:
...
This is achieved by defining a custom annotation with attributes:
