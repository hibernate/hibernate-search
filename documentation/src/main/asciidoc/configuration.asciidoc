...
link:{hibernateSearchJavadocUrl}/org/hibernate/search/backend/elasticsearch/cfg/ElasticsearchBackendSettings.html[ElasticsearchBackendSettings]
link:{hibernateSearchJavadocUrl}/org/hibernate/search/backend/lucene/cfg/LuceneBackendSettings.html[LuceneBackendSettings]
...
----
include::{sourcedir}/org/hibernate/search/documentation/configuration/MyConfiguration.java[tags=build-hibernate-configuration]
----
====
