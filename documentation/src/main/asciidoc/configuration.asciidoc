...
Unpack the modules in your WildFly `modules` directory: this will create modules for Hibernate Search.
...
You will also need to update the dependencies of Hibernate Search. Here is a list of the dependencies to update:
