...
is now `org.hibernate.search.engine.search.predicate.factories.PredicateDefinition`.
* org.hibernate.search.engine.search.predicate.factories.NamedPredicateProviderContext`
is now `org.hibernate.search.engine.search.predicate.factories.PredicateDefinitionContext`.
