...
the resulting projected distance will always be `Double.MAX_VALUE` (`1.7976931348623157e+308`).
====
 ...
 * otherwise, the resulting distance will always be `Double.MAX_VALUE` (`1.7976931348623157e+308`),
   and the entity will be ranked accordingly:
   last if the sort is ascending, or first if the sort is descending.
====
