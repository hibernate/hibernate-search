...
.Using the `PARSE` DSL converter to work with string arguments
====
[source, JAVA, indent=0]
----
include::{sourcedir}/org/hibernate/search/documentation/search/converter/DslConverterIT.java[tags=dsl-converter-parse]
----
====
