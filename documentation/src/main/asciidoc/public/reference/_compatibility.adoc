...
[[compatibility-search-dependencies-platforms]]
==== Hibernate Search Platforms
...
Currently, there are three platform POM files provided:

* `hibernate-search-platform-lucene` that manages versions of published artifacts that belong to the following group ids:
...
* `hibernate-search-platform-lucene-next` that manages versions of published artifacts that belong to the following group ids:
    - `org.hibernate.search` for the {hibernateSearchVersion} version of Hibernate Search;
    - `org.hibernate.orm` for the {hibernateVersion} version of Hibernate ORM;
    - `org.apache.lucene` for the {luceneNextVersion} version of Lucene;
* `hibernate-search-platform-elasticsearch` that manages versions of published artifacts that belong to the following group ids:
    - `org.hibernate.search` for the {hibernateSearchVersion} version of Hibernate Search;
    - `org.hibernate.orm` for the {hibernateVersion} version of Hibernate ORM;
...
.Importing the Hibernate Search Lucene platform
[source, XML, subs="+attributes"]
----
<dependencyManagement>
    <dependencies>
        <!--
            Import Hibernate Search Lucene platform
            to get all of its artifact versions aligned:
        -->
        <dependency>
            <groupId>org.hibernate.search</groupId>
            <artifactId>hibernate-search-platform-lucene</artifactId>
            <version>{hibernateSearchVersion}</version>
            <type>pom</type>
            <scope>import</scope>
        </dependency>
