...
include::{documentationConfigPropertiesOutputDirectory}/_hibernate-search-backend-elasticsearch-client-rest4.adoc[opts=optional]
include::{documentationConfigPropertiesOutputDirectory}/_hibernate-search-backend-elasticsearch-client-rest5.adoc[opts=optional]
include::{documentationConfigPropertiesOutputDirectory}/_hibernate-search-backend-elasticsearch-client-opensearch-rest.adoc[opts=optional]
