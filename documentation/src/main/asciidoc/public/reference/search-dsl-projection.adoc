...
include::../components/field-projection-important.adoc[]
...
include::../components/custom-projection-type-important.adoc[]
...
include::../components/custom-projection-type-nonrecord-tip.adoc[]
...
include::../components/deprecated-warning.adoc[]
...
include::../components/explanation-warning.adoc[]
