...
(link:{elasticsearchDocUrl}/query-dsl-query-string-query.html#query-string-syntax[Elasticsearch]/link:{openSearchDocUrl}/query-dsl/full-text/query-string/[OpenSearch]/link:{luceneJavadocUrl}../queryparser/org/apache/lucene/queryparser/classic/package-summary.html#package.description/[Lucene])
guides.
