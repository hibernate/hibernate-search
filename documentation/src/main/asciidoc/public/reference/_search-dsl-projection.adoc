...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedirJava17}/org/hibernate/search/documentation/search/projection/MyAuthorPlaceProjection.java[tags=include]
----
<1> Annotate the record type with <<mapping-projection-basics,`@ProjectionConstructor`>>.
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedirJava17}/org/hibernate/search/documentation/search/projection/ProjectionDslJava17IT.java[tags=projection-constructor-distance]
----
<1> Pass the custom projection type to `.select(...)`.
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedirJava17}/org/hibernate/search/documentation/search/projection/ProjectionDslJava17IT.java[tags=programmatic-distance-projection]
----
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedirJava17}/org/hibernate/search/documentation/search/projection/MyBookHighlightedTitleProjection.java[tags=include]
----
<1> Annotate the record type with <<mapping-projection-basics,`@ProjectionConstructor`>>.
<2> Annotate the parameter that should receive the highlights value with `@HighlightProjection`.
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedirJava17}/org/hibernate/search/documentation/search/projection/ProjectionDslJava17IT.java[tags=projection-constructor-highlight-single]
----
<1> Pass the custom projection type to `.select(...)`.
