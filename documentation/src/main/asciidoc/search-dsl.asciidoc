...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/query/QueryDslIT.java[tags=fetching-searchResult]
----
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/query/QueryDslIT.java[tags=fetching-totalHitCount]
----
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/query/QueryDslIT.java[tags=fetching-hits]
----
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/query/QueryDslIT.java[tags=fetching-singleHit]
----
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/query/QueryDslIT.java[tags=fetching-all-searchResult]
----
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/query/QueryDslIT.java[tags=fetching-all-hits]
----
====
...
Pagination is achieved in Hibernate Search by passing a limit and offset to the `fetch` or `fetchHits` method:
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/query/QueryDslIT.java[tags=fetching-pagination-searchResult]
----
<1> Set the limit to `20` and the offset to `40`.
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/query/QueryDslIT.java[tags=fetching-pagination-hits]
----
<1> Set the limit to `20` and the offset to `40`.
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/query/QueryDslIT.java[tags=cacheLookupStrategy-persistenceContextThenSecondLevelCache]
----
<1> Start building the query.
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/query/QueryDslIT.java[tags=fetchSize]
----
<1> Start building the query.
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/query/QueryDslIT.java[tags=searchQuery]
----
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/query/QueryDslIT.java[tags=searchQuery-toORM]
----
<1> Build the query as usual.
<2> Retrieve a `SearchQuery` object.
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/query/QueryDslIT.java[tags=explain-lucene]
----
<1> Build the query as usual,
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/query/QueryDslIT.java[tags=explain-elasticsearch]
----
<1> Build the query as usual,
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/predicate/PredicateDslIT.java[tags=phrase-slop]
----
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/predicate/PredicateDslIT.java[tags=simpleQueryString-defaultOperator-and]
----
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/predicate/PredicateDslIT.java[tags=simpleQueryString-phrase-slop]
----
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/sort/SortDslIT.java[tags=score]
----
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/sort/SortDslIT.java[tags=indexOrder]
----
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/sort/SortDslIT.java[tags=field]
----
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/sort/SortDslIT.java[tags=field-missing-first]
----
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/sort/SortDslIT.java[tags=field-missing-last]
----
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/sort/SortDslIT.java[tags=field-missing-use]
----
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/sort/SortDslIT.java[tags=distance]
----
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/sort/SortDslIT.java[tags=composite]
----
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/sort/SortDslIT.java[tags=composite_dynamicParameters]
----
<1> Get a custom object holding the search parameters provided by the user through a web form, for example.
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/aggregation/AggregationDslIT.java[tags=entryPoint-lambdas]
----
...
[source, JAVA, indent=0]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/aggregation/AggregationDslIT.java[tags=entryPoint-objects]
----
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/aggregation/AggregationDslIT.java[tags=terms]
----
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/aggregation/AggregationDslIT.java[tags=terms-noConverter]
----
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/aggregation/AggregationDslIT.java[tags=terms-max-term-count]
----
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/aggregation/AggregationDslIT.java[tags=terms-min-doc-count-zero]
----
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/aggregation/AggregationDslIT.java[tags=terms-min-doc-count-high]
----
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/aggregation/AggregationDslIT.java[tags=terms-order-term-ascending]
----
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/aggregation/AggregationDslIT.java[tags=terms-order-term-descending]
----
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/aggregation/AggregationDslIT.java[tags=terms-order-count-ascending]
----
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/aggregation/AggregationDslIT.java[tags=range]
----
<1> Define the path and type of the field whose values should be considered.
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/aggregation/AggregationDslIT.java[tags=range-objects]
----
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/aggregation/AggregationDslIT.java[tags=range-noConverter]
----
====
...
// TODO document extensions when we add them
...
or `missing().use(Object) in the sort DSL.
