...
// TODO
//  1. Fetching the top hits and other results (total hit count, aggregations, ...)
//  2. Fetching the top hits only
//  3. Fetching the only hit
//  4. Fetching the total hit count only
