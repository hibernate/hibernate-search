...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/sort/SortDslIT.java[tags=field_onMissingValue_sortFirst]
----
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/sort/SortDslIT.java[tags=field_onMissingValue_sortLast]
----
====
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/searchdsl/sort/SortDslIT.java[tags=field_onMissingValue_use]
----
====
