...
[[mapper-orm-bridge-routingbridge-conditionalindexing]]
== [[example-search-mapping-indexinginterceptor-blog]] Using a routing bridge for conditional indexing
...
== [[mapper-orm-bridge-routingkeybridge-parameters]] Passing parameters
...
== [[mapper-orm-bridge-routingkeybridge-programmatic]] Programmatic mapping
