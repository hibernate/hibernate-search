...
[[mapper-orm-bridge-identifierbridge-basics]]
== Basics
...
[[mapper-orm-bridge-identifierbridge-type-resolution]]
== Type resolution
...
[[mapper-orm-bridge-identifierbridge-iscompatiblewith]]
...
[[mapper-orm-bridge-identifierbridge-parameters]]
== [[_passing_parameters]] Passing parameters
...
[[mapper-orm-bridge-identifierbridge-access-orm]]
...
[[mapper-orm-bridge-identifierbridge-injecting-beans]]
== [[_injecting_beans_into_the_bridge_or_binder]] Injecting beans into the bridge or binder
...
[[mapper-orm-bridge-identifierbridge-incubating]]
== Incubating features
