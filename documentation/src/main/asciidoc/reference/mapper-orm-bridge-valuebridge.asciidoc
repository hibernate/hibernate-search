...
= [[_stringbridge]] Value bridge

[[mapper-orm-bridge-valuebridge-basics]]
== Basics
...
[[mapper-orm-bridge-valuebridge-type-resolution]]
== Type resolution
...
== [[section-two-way-bridge]] Supporting projections with `fromIndexedValue()`
...
[[mapper-orm-bridge-valuebridge-iscompatiblewith]]
...
[[mapper-orm-bridge-valuebridge-parameters-string]]
...
[[mapper-orm-bridge-valuebridge-parameters-custom-annotation]]
...
[[mapper-orm-bridge-valuebridge-access-orm]]
...
[[mapper-orm-bridge-valuebridge-injection]]
...
[[mapper-orm-bridge-valuebridge-programmatic]]
== Programmatic mapping

You can apply a value bridge through the <<mapper-orm-programmatic-mapping,programmatic mapping>> too.
...
[[mapper-orm-bridge-valuebridge-incubating]]
== Incubating features
