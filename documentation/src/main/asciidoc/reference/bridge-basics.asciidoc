...
|===
|Bridge type
|<<bridge-valuebridge,`ValueBridge`>>
|<<bridge-propertybridge,`PropertyBridge`>>
|<<bridge-typebridge,`TypeBridge`>>
|<<bridge-identifierbridge,`IdentifierBridge`>>
|<<bridge-routingbridge,`RoutingBridge`>>
...
No <<bridge-index-field-dsl-object,object field>> (composite).
|One index field or more.
Value fields as well as <<bridge-index-field-dsl-object,object fields>> (composite).
|One index field or more.
Value fields as well as <<bridge-index-field-dsl-object,object fields>> (composite).
|Document identifier
