...
<8> Create a subfield for the `total` amount of the invoice,
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/mapper/orm/binding/propertybridge/param/context/InvoiceLineItemsSummaryBinder.java[tags=include]
----
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/mapper/orm/binding/propertybridge/param/context/Invoice.java[tags=include;!getters-setters]
----
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/mapper/orm/binding/propertybridge/param/InvoiceLineItemsSummaryBinding.java[tags=include]
----
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/mapper/orm/binding/propertybridge/param/InvoiceLineItemsSummaryBinder.java[tags=include]
----
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/mapper/orm/binding/propertybridge/param/Invoice.java[tags=include;!getters-setters]
----
<1> Apply the bridge using its custom annotation,
setting the `fieldName` parameter.
====

[[binding-propertybridge-parameters-access-orm]]
...
[[binding-propertybridge-parameters-injecting-beans]]
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/mapper/orm/binding/propertybridge/param/PropertyBridgeParamIT.java[tags=programmatic]
----
====

[[binding-propertybridge-parameters-incubating]]
