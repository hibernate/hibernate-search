...
[[mapper-orm-bridge-routingbridge-basics]]
== Basics
...
* <<bridge-routingbridge-conditionalindexing>>
* <<bridge-routingbridge-routingkey>>
...
[[bridge-routingbridge-parameters]]
...
Refer to <<bridge-typebridge-parameters,this example for `TypeBinder`>>,
which is fairly similar to what you'll need for a `RoutingBinder`.

[[bridge-routingbridge-ormsession]]
...
[[bridge-routingbridge-injection]]
...
[[bridge-routingbridge-programmatic]]
...
[[bridge-routingbridge-incubating]]
