...
[source]
----
# hibernate.search.backend.request_timeout = (not defined by default)
hibernate.search.backend.connection_timeout = 1000 (default)
hibernate.search.backend.read_timeout = 30000 (default)
----
...
----
# To configure the defaults for all indexes:
hibernate.search.backend.dynamic_mapping = strict (default)
# To configure a specific index:
hibernate.search.backend.indexes.<index name>.dynamic_mapping = strict (default)
----
