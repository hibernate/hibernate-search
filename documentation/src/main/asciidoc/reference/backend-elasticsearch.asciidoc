...
(<<mapper-orm-indexing-automatic-configuration,completely>> or <<mapping-reindexing-reindexonupdate,partially>>)
...
<<mappingthe mapping configured through Hibernate Search's mapping APIs>>,
