...
When using a <<bridge-typebridge,type bridge>> or a <<bridge-propertybridge,property bridge>>,
...
This is done through a dedicated DSL, accessible from the `bind(...)` method of <<bridge-typebridge,`TypeBinder`>>
and <<bridge-propertybridge,`PropertyBinder`>>.
...
see <<bridge-bridgedelement-dependencies-useRootOnly>>.
...
[[bridge-bridgedelement-dependencies-containers]]
...
[[bridge-bridgedelement-dependencies-useRootOnly]]
...
[[bridge-bridgedelement-dependencies-fromOtherEntity]]
