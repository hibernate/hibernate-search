...
For more complex projections, it is possible to <<mapper-orm-mapping-projection,define a custom (annotated) record or class>>
...
Hibernate Search will <<mapper-orm-mapping-projection-inner-inference,infer the inner projections>>
...
NOTE: For more information about mapping custom projection types, see <<mapper-orm-mapping-projection>>.
...
For more information about  mapping projection types, see <<mapper-orm-mapping-projection>>.
...
<<mapper-orm-indexedembedded-structure-nested,`NESTED` structure>>.
