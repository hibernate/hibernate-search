...
[[bridge-resolver-single-binder-multiple-types]]
...
<2> <<bridge-valuebridge-incubating,Retrieve the type of the element being bridged>>.
<3> <<bridge-valuebridge-injection,Retrieve an external service>> (through CDI/Spring).
