...
[[mapper-orm-bridge-resolver-basics]]
== Basics
...
[[mapper-orm-bridge-resolver-single-binder-multiple-types]]
== [[_assigning_a_single_binder_to_multiple_types]] Assigning a single binder to multiple types
