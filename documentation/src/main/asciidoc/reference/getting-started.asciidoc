...
Spring Boot 2.3.x is affected by a bug that causes the application to hang on startup when using Hibernate Search.
...
but hasn't been fixed yet in Spring Boot 2.3.5.
