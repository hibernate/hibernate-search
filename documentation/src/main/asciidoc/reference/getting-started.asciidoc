...
[[gettingstarted-framework-quarkus]]
=== [[_quarkus]] Quarkus
...
[[gettingstarted-framework-spring-boot]]
=== [[_spring_boot]] Spring Boot

Hibernate Search can easily be integrated into a link:{springBootUrl}[Spring Boot] application.
Just read about Spring Boot's specifics below, then follow the getting started guide.

[[gettingstarted-framework-spring-boot-configuration-properties]]
...
[[gettingstarted-framework-spring-boot-dependency-versions]]
==== [[_dependency_versions]] Dependency versions
...
[[gettingstarted-framework-spring-boot-application-hanging]]
==== [[_application_hanging_on_startup]] Application hanging on startup
...
[[gettingstarted-framework-other]]
=== Other
...
[[getting-started-initialization-schema-management]]
=== [[_schema_management]] Schema management
...
[[getting-started-initialization-indexing]]
=== [[_initial_indexing]] Initial indexing
...
* The <<architecture-examples>> give an idea of how data flows inside and outside a Hibernate Search application.
* The link:https://github.com/quarkusio/quarkus-quickstarts/tree/main/hibernate-search-orm-elasticsearch-quickstart[Quarkus quickstart],
a sample application using Hibernate Search with the link:https://quarkus.io/[Quarkus] framework.
* The link:https://github.com/hibernate/hibernate-search/tree/main/integrationtest/showcase/library["Library" showcase],
a sample application using Hibernate Search with the link:https://spring.io/projects/spring-boot[Spring Boot] framework.
