...
...
+
Full-text fields should be assigned an <<mapper-orm-directfieldmapping-analyzer,analyzer>>, referenced by its name.
...
== [[section-built-in-bridges]] Supported property types
...
|java.sql.Time
 ...
 |See <<mapper-orm-legacy-date-time-apis>>.
 |`Instant.parse(String)`
|<<mapper-orm-geopoint-basics,GeoPoint>> and subtypes|-|-|Latitude as double and longitude as double, separated by a comma. Ex: `41.8919, 12.51133`.
|===
