...
This can be achieved by defining a custom <<bridge-valuebridge,`ValueBridge<AuthenticationOutcome, String>`>>
...
See <<bridge-typebridge>> or <<bridge-propertybridge>> for more information.
====
...
See <<bridge-valuebridge>>,
<<bridge-propertybridge>> or <<bridge-typebridge>> for more information.
====
