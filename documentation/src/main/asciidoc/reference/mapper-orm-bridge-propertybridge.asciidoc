...
You can define string parameters to the `@PropertyBinderRef` annotation and then use them later in the binder:
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/mapper/orm/bridge/propertybridge/parameter/context/Invoice.java[tags=include;!getters-setters]
----
...
[source, JAVA, indent=0, subs="+callouts"]
----
include::{sourcedir}/org/hibernate/search/documentation/mapper/orm/bridge/propertybridge/parameter/context/InvoiceLineItemsSummaryBinder.java[tags=include]
----
