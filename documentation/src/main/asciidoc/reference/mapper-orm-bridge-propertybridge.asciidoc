...
if the type of the bridged property is a `java.util.List`,
it is possible to bind the bridge using the `listPropertyBridge` method,
to statically define the type of the elements.
...
One generic type arguments must be provided: the type of the property,
