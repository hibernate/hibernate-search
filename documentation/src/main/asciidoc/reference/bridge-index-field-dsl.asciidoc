...
[[bridge-index-field-dsl-type-objects]]
...
[[bridge-index-field-dsl-multi-valued-fields]]
...
[[bridge-index-field-dsl-object-structure]]
...
[[bridge-index-field-dsl-dynamic]]
...
A field template is always declared in a binder: either in a <<bridge-typebridge,type binder>>
or in a <<bridge-propertybridge,property binder>>.
...
For example, if you declare templates at the root of your entity (through a <<bridge-typebridge,type bridge>>),
