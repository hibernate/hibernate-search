...
[[mapper-orm-bridge-index-field-type-dsl-basics]]
== Basics
...
[[mapper-orm-bridge-index-field-type-dsl-data-types]]
== [[_available_data_types]] Available data types
...
[[mapper-orm-bridge-index-field-type-dsl-options]]
== [[_available_type_options]] Available type options
...
[[mapper-orm-bridge-index-field-type-dsl-converter]]
== [[_dsl_converter]] DSL converter
...
[[mapper-orm-bridge-index-field-type-dsl-projection-converter]]
== [[_projection_converter]] Projection converter
...
[[mapper-orm-bridge-index-field-type-dsl-backend-specific-types]]
== [[_backend_specific_types]] Backend-specific types
