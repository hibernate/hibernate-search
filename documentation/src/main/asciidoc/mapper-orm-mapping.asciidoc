...
but this can be solved by <<mapper-orm-indexing-explicit,triggering reindexing manually>>,
...
2. Rebuild the index, for example using the <<mapper-orm-indexing-explicit-massindexer,`MassIndexer`>>.
