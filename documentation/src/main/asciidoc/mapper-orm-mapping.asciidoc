...
...
+
Full-text fields must be assigned an <<analyzer,mapper-orm-directfieldmapping-analyzer>>, referenced by its name.
...
+
Keyword fields may be assigned a <<normalizer,mapper-orm-directfieldmapping-normalizer>>, referenced by its name.
