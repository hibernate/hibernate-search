...
Provided the entity identifier has a <<mapper-orm-bridge-identifierbridge-builtin,supported type>>,
...
meaning they are supported out-of-the box for <<mapper-orm-directfieldmapping,property/field mapping>> using `@*Field` annotations.
...
|org.hibernate.search.engine.spatial.GeoPoint|-| Latitude as double and longitude as double, separated by a comma. Ex: `41.8919, 12.51133`.
|===
