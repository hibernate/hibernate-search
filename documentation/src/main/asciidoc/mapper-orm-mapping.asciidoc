...
`indexNullAs`::
Disabled by default. Whether it is set, it allows to provide a value to use as a replacement anytime the property value is null.

[IMPORTANT]
====
The replacement is provided using a String. So its value has to be parsable according to the index field type relative to the property.
Look up the column _Parsing method for 'indexNullAs'_ in the <<section-built-in-bridges>>.
====
...
|java.lang.String|- | -
|java.lang.Character, char|A single-character `java.lang.String`| A single-character `java.lang.String`
...
|java.lang.Boolean, boolean|-| A `true` or `false` ignoring case `java.lang.String`
...
|java.time.ZonedDateTime|- | Same as `ZonedDateTime.parse(String)` for JDK9+
|java.time.ZoneId|`getId()` as a `java.lang.String` | ZoneId.of(String)
|java.time.ZoneOffset|`getTotalSeconds()` as a `java.lang.Integer` | `getTotalSeconds()` as a `java.lang.String`
|java.time.Period|A formatted `java.lang.String`: `<years on 11 characters><months on 11 characters><days on 11 characters>` |A formatted `java.lang.String`: `<years on 11 characters><months on 11 characters><days on 11 characters>`
|java.time.Duration|`toNanos()` as a `java.lang.Long` | `Long.parseLong(String)`
...
|java.util.Calendar|A `java.time.ZonedDateTime` representing the same date/time and timezone; see <<mapper-orm-legacy-date-time-apis>> |  Same as `ZonedDateTime.parse(String)` for JDK9+
