...
* `org.hibernate.search.integrationtest.fullstack.library.bridge.ISBNBridge` implements `ValueBridge`.
* `org.hibernate.search.integrationtest.fullstack.library.bridge.MultiKeywordStringBridge` implements `PropertyBridge`.
The corresponding annotation is `org.hibernate.search.integrationtest.fullstack.library.bridge.annotation.MultiKeywordStringBridge`.
* `org.hibernate.search.integrationtest.fullstack.library.bridge.AccountBorrowalSummaryBridge` implements `TypeBridge`.
The corresponding annotation is `org.hibernate.search.integrationtest.fullstack.library.bridge.annotation.AccountBorrowalSummaryBridge`.
