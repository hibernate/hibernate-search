...
public class CompressionTest extends SearchTestCase {
	...
	public void testFieldWasCompressed() throws Exception {
		IndexReader indexReader = getSearchFactory().getIndexReaders().openIndexReader( LargeDocument.class );
		try {
			...
			getSearchFactory().getIndexReaders().closeIndexReader( indexReader );
		}
	}
