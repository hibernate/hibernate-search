...
public class LuceneFullTextManager implements FullTextManager {
	...
	public <T> T get(Class<T> entityType, Serializable id) {
		final EntityIndexMapping<?> indexMapping = searchFactory.getDocumentBuilderIndexedEntity( entityType );
	...
	public <T> void index(T entity) {
		...
		final EntityIndexMapping<?> indexMapping = searchFactory.getDocumentBuilderIndexedEntity( clazz );
		if ( indexMapping == null ) {
			String msg = "Entity to index is not an @Indexed entity: " + entity.getClass().getName();
			throw new IllegalArgumentException( msg );
		}
		Serializable id = indexMapping.getDocumentBuilder().getId( entity );
