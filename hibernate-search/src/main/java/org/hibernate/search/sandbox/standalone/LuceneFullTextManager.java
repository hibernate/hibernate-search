...
public class LuceneFullTextManager implements FullTextManager {
	...
	public <T> T get(Class<T> entityType, Serializable id) {
		final EntityIndexMapping<?> indexMapping = searchFactory.getIndexMappingForEntity( entityType );
	...
	public <T> void index(T entity) {
		...
		final EntityIndexMapping<?> indexMapping = searchFactory.getIndexMappingForEntity( clazz );
		if ( indexMapping == null ) {
