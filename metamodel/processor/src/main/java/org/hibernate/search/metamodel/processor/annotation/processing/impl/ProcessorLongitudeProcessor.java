...
public class ProcessorLongitudeProcessor extends AbstractProcessorAnnotationProcessor {
	...
	public void process(PropertyMappingStep mapping, AnnotationMirror annotation, Element element,
		...
		mapping.marker( GeoPointBinder.longitude().markerSet( getAnnotationValueAsString( annotation, "markerSet", "" ) ) );
	}
	...
	protected Optional<IndexFieldTypeFinalStep<?>> configureField(PropertyBindingContext bindingContext,
		...
		context.messager().printMessage( Diagnostic.Kind.ERROR, "Longitude is not allowed within binders.", element );
