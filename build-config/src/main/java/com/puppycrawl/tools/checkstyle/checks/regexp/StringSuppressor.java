...
/**
 * {@link MatchSuppressor} used to check if a checkstyle violation happens inside a {@link String}.
 *
...
public class StringSuppressor implements MatchSuppressor {
	 ...
	 * <p>
	 * This function is very simple and it works because we are looking for white spaces.
	 *
	 * @param line
