...
public class SimpleGlobPatternTest {
	...
	public static Object[][] parameters() {
		return new Object[][] {
				...
				{ "foo", Collections.singleton( "foo" ),
						Arrays.asList( "", "fooo", "afoo", "bar", "foobar", "fo", "oo" ), "foo", "foo", "foo" },
				{ "*a", Arrays.asList( "a", "aa", "ba", "baa" ),
						Arrays.asList( "", "ab", "bab", "b" ), "*a", "*a", null },
				{ "*foo", Arrays.asList( "foo", "afoo", "barfoo" ),
						Arrays.asList( "", "fooo", "bar", "foobar", "fo", "oo" ), "*foo", "*foo", null },
				{ "a*", Arrays.asList( "a", "aa", "ab" ),
						Arrays.asList( "", "bab", "b", "ba", "baa" ), "a*", "a*", null },
				{ "foo*", Arrays.asList( "foo", "foobar", "fooo" ),
						Arrays.asList( "", "afoo", "bar", "barfoo", "fo", "oo" ), "foo*", "foo*", null },
				{ "a*b", Arrays.asList( "ab", "aab", "abb", "afoob" ),
						Arrays.asList( "", "bab", "tab", "bat", "a", "b" ), "a*b", "a*b", null },
				{ "a**b", Arrays.asList( "ab", "aab", "abb", "afoob" ),
						Arrays.asList( "", "bab", "tab", "bat", "a", "b" ), "a*b", "a*b", null },
				{ "a*b*", Arrays.asList( "ab", "aab", "abb", "aba", "abab", "afoob", "afoobfoo" ),
						Arrays.asList( "", "bab", "tab", "bat", "a", "b" ), "a*b*", "a*b*", null },
				// Backtracking
				{ "foo*bar*boo", Arrays.asList( "foobarboo", "fooobarboo", "foobaraboo", "foobaraboo", "fooobaraboo" ),
