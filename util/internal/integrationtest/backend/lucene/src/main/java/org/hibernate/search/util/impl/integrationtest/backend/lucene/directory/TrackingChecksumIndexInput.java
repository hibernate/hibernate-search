...
class TrackingChecksumIndexInput extends ChecksumIndexInput {

	private final ChecksumIndexInput delegate;
	private final OpenResourceTracker tracker;

	public TrackingChecksumIndexInput(ChecksumIndexInput delegate, OpenResourceTracker tracker) {
		super( "TrackingChecksumIndexInput(" + delegate.toString() + ")" );
