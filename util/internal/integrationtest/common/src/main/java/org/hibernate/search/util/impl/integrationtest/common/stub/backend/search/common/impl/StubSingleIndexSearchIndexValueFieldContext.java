...
public class StubSingleIndexSearchIndexValueFieldContext<F>
		implements StubSearchIndexValueFieldContext<F> {

	private final String absolutePath;
	private final StubIndexValueFieldType<F> type;

	public StubSingleIndexSearchIndexValueFieldContext(String absolutePath, StubIndexValueFieldType<F> type) {
