...
public class StubSingleIndexSearchCompositeIndexSchemaElementContext
		implements StubSearchCompositeIndexSchemaElementContext {

	private final String absolutePath;
	private final ObjectStructure objectStructure;

	public StubSingleIndexSearchCompositeIndexSchemaElementContext(String absolutePath, ObjectStructure objectStructure) {
