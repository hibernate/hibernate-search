...
public class ComposedExtension implements AfterAllCallback, AfterEachCallback, AfterTestExecutionCallback,
	...
	public static class FullExtension implements AfterAllCallback, AfterEachCallback, AfterTestExecutionCallback,
			BeforeAllCallback, BeforeEachCallback, BeforeTestExecutionCallback, TestExecutionExceptionHandler {
		...
		public FullExtension(Extension extension) {
			...
			this.afterTestExecutionCallback = extension instanceof AfterTestExecutionCallback ?
					( (AfterTestExecutionCallback) extension )::afterTestExecution : DO_NOTHING;
			...
			this.beforeEachCallback =
					extension instanceof BeforeEachCallback ? ( (BeforeEachCallback) extension )::beforeEach :
							DO_NOTHING;
			this.beforeTestExecutionCallback = extension instanceof BeforeTestExecutionCallback ?
					( (BeforeTestExecutionCallback) extension )::beforeTestExecution : DO_NOTHING;
			this.testExecutionExceptionHandler = extension instanceof TestExecutionExceptionHandler ?
					( (TestExecutionExceptionHandler) extension )::handleTestExecutionException : BI_DO_NOTHING;
		}
