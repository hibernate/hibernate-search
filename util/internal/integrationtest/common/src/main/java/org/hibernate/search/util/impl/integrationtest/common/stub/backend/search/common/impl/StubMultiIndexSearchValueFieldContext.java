...
public class StubMultiIndexSearchValueFieldContext<F>
		extends AbstractStubMultiIndexSearchIndexSchemaElementContext<StubSearchValueFieldContext<F>>
		implements StubSearchValueFieldContext<F>, StubSearchValueFieldTypeContext<F> {

	public StubMultiIndexSearchValueFieldContext(StubSearchIndexScope scope, String absolutePath,
			List<StubSearchValueFieldContext<F>> elementForEachIndex) {
	...
	protected <T> StubSearchQueryElementFactory<T> queryElementFactory(
			StubSearchValueFieldContext<F> indexElement, SearchQueryElementTypeKey<T> key) {
	...
	private <T> T getFromTypeIfCompatible(Function<StubSearchValueFieldTypeContext<F>, T> getter,
		...
		T attribute = null;
		for ( StubSearchValueFieldContext<F> indexElement : elementForEachIndex ) {
