...
public abstract class AbstractStubMultiIndexSearchIndexNodeContext<E extends StubSearchIndexNodeContext>
		implements StubSearchIndexNodeContext {

	protected final StubSearchIndexScope scope;
	protected final String absolutePath;
	protected final List<E> elementForEachIndex;

	public AbstractStubMultiIndexSearchIndexNodeContext(StubSearchIndexScope scope,
	...
	public final <T> AbstractStubSearchQueryElementFactory<T> queryElementFactory(SearchQueryElementTypeKey<T> key) {
		AbstractStubSearchQueryElementFactory<T> factory = null;
		for ( E indexElement : elementForEachIndex ) {
			AbstractStubSearchQueryElementFactory<T> factoryForIndexElement =
	...
	protected abstract <T> AbstractStubSearchQueryElementFactory<T> queryElementFactory(E indexElement,
	...
	private <T> void checkFactoryCompatibility(SearchQueryElementTypeKey<T> key,
			AbstractStubSearchQueryElementFactory<T> factory1,
			AbstractStubSearchQueryElementFactory<T> factory2) {
