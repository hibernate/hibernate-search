...
public class JavaBeanEntityTypeMetadata<E> {
	...
	private JavaBeanEntityTypeMetadata(String name, Builder<E> builder) {
		this.name = name;
	...
	public static class Builder<E> implements EntityConfigurationContext<E> {
		...
		public JavaBeanEntityTypeMetadata<E> build() {
			return new JavaBeanEntityTypeMetadata<>( name, this );
		}
	}
}