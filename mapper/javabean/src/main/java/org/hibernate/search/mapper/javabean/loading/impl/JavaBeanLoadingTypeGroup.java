...
public final class JavaBeanLoadingTypeGroup<E> implements LoadingTypeGroup<E> {
	...
	public JavaBeanLoadingTypeGroup(LoadingTypeContextProvider typeContextProvider,
