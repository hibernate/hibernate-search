...
public class PropertyBindingContextImpl<P> extends AbstractCompositeBindingContext
	...
	@Override
	public void setBridge(PropertyBridge bridge) {
		setBridge( BeanHolder.of( bridge ) );
	}

	@Override
	public void setBridge(BeanHolder<? extends PropertyBridge> bridgeHolder) {
	...
	public Optional<BoundPropertyBridge<P>> applyBuilder(PropertyBridgeBuilder bridgeBuilder) {
		try {
