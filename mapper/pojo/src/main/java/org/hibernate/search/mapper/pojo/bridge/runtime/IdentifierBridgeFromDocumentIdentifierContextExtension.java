...
/**
 * An extension to {@link IdentifierBridgeFromDocumentIdentifierContext}, allowing to access non-standard context
 ...
 *
 * @see IdentifierBridgeFromDocumentIdentifierContext#extension(IdentifierBridgeFromDocumentIdentifierContextExtension)
 */
public interface IdentifierBridgeFromDocumentIdentifierContextExtension<T> {
	 ...
	 *
	 * @param original The original, non-extended {@link IdentifierBridgeFromDocumentIdentifierContext}.
	 ...
	 */
	Optional<T> extendOptional(IdentifierBridgeFromDocumentIdentifierContext original, SessionContextImplementor sessionContext);
