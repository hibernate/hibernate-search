...
/**
 * An extension to {@link PropertyBridgeWriteContext}, allowing to access non-standard context
 ...
 *
 * @see PropertyBridgeWriteContext#extension(PropertyBridgeWriteContextExtension)
 */
public interface PropertyBridgeWriteContextExtension<T> {
	 ...
	 *
	 * @param original The original, non-extended {@link PropertyBridgeWriteContext}.
	 ...
	 */
	Optional<T> extendOptional(PropertyBridgeWriteContext original, SessionContextImplementor sessionContext);
