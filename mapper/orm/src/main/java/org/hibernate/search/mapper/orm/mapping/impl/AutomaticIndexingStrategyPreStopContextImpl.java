...
public class AutomaticIndexingStrategyPreStopContextImpl implements AutomaticIndexingStrategyPreStopContext {
	private final MappingPreStopContext delegate;

	public AutomaticIndexingStrategyPreStopContextImpl(MappingPreStopContext delegate) {
