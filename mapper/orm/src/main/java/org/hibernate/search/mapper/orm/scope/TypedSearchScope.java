...
public interface TypedSearchScope<SR, E> {
	 ...
	 * <p>
	 * The highlighter will only be valid for {@link org.hibernate.search.mapper.orm.session.SearchSession#search(TypedSearchScope) search queries}
	 * created using this scope or another scope instance targeting the same indexes.
	 * <p>
	 * Note this method is only necessary if you do not want to use lambda expressions,
