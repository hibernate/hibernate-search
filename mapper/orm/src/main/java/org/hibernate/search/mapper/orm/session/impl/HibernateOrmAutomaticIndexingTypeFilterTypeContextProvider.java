...
public interface HibernateOrmAutomaticIndexingTypeFilterTypeContextProvider {

	KeyValueProvider<String, ? extends PojoTypeContext<?>> byEntityName();

	KeyValueProvider<Class<?>, PojoRawTypeIdentifier<?>> indexedWithSuperTypesByExactClass();
