...
public final class DefaultJavaUtilDateIdentifierBridge implements IdentifierBridge<Date> {
	...
	public Date fromDocumentIdentifier(String documentIdentifier, IdentifierBridgeFromDocumentIdentifierContext context) {
		return DefaultJavaUtilDateValueBridge.from( ParseUtils.parseInstant( documentIdentifier ) );
	}
