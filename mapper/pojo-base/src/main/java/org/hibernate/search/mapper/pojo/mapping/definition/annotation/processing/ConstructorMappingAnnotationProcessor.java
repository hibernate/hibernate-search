...
public interface ConstructorMappingAnnotationProcessor<A extends Annotation> {
	 ...
	 * contribute to the mapping passed in parameter.
	 * @param mapping The mapping to contribute to, targeting the constructor that the annotation was applied to.
	 * @param annotation The annotation to process.
	 * @param context A context providing various information and helpers.
	 */
	void process(ConstructorMappingStep mapping, A annotation, ConstructorMappingAnnotationProcessorContext context);
