 ...
 *
 * @see ValueBridgeFromIndexedValueContext#extension(ValueBridgeFromIndexedValueContextExtension)
 */
public interface ValueBridgeFromIndexedValueContextExtension<T> {
	 ...
	 */
	Optional<T> extendOptional(ValueBridgeFromIndexedValueContext original,
