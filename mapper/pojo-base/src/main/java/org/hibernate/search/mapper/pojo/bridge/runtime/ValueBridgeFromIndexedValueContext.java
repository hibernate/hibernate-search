 ...
 * {@link org.hibernate.search.mapper.pojo.bridge.ValueBridge#fromIndexedValue(Object, ValueBridgeFromIndexedValueContext)}.
 */
public interface ValueBridgeFromIndexedValueContext {
	 ...
	 */
	<T> T extension(ValueBridgeFromIndexedValueContextExtension<T> extension);
