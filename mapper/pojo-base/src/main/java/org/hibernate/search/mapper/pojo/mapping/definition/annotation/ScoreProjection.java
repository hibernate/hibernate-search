...
import org.hibernate.search.mapper.pojo.mapping.definition.annotation.processing.impl.ScoreProjectionProcessor;
...
@MethodParameterMapping(processor = @MethodParameterMappingAnnotationProcessorRef(type = ScoreProjectionProcessor.class, retrieval = BeanRetrieval.CONSTRUCTOR))
