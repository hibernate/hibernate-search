...
public interface ProjectionBindingContext {
	...
	default <T> BeanHolder<? extends ProjectionDefinition<List<T>>> createObjectDefinitionMulti(String fieldPath,
		...
		return createObjectDefinitionMulti( fieldPath, projectedType, filter, MultiProjectionTypeReference.list() );
	}
	 ...
	 */
	@Incubating
	<C, T> BeanHolder<? extends ProjectionDefinition<C>> createObjectDefinitionMulti(String fieldPath,
			Class<T> projectedType, TreeFilterDefinition filter, MultiProjectionTypeReference<C, T> collectionTypeReference);
