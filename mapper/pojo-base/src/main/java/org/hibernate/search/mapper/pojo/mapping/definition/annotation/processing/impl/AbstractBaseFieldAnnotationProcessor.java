...
abstract class AbstractBaseFieldAnnotationProcessor<A extends Annotation> implements PropertyMappingAnnotationProcessor<A> {
	...
	public final void process(PropertyMappingStep mappingContext, A annotation,
		...
		PropertyMappingFieldOptionsStep<?> fieldContext =
				initBaseFieldMappingContext( context, mappingContext, annotation, cleanedUpRelativeFieldName );
	...
	abstract PropertyMappingFieldOptionsStep<?> initBaseFieldMappingContext(PropertyMappingAnnotationProcessorContext context,
