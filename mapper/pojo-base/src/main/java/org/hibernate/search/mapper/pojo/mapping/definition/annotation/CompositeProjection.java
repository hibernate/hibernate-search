...
@MethodParameterMapping(processor = @MethodParameterMappingAnnotationProcessorRef(type = CompositeProjectionProcessor.class, retrieval = BeanRetrieval.CONSTRUCTOR))
