...
public final class DefaultJavaSqlDateIdentifierBridge implements IdentifierBridge<Date> {
	...
	public Date fromDocumentIdentifier(String documentIdentifier, IdentifierBridgeFromDocumentIdentifierContext context) {
		return DefaultJavaSqlDateValueBridge.from( ParseUtils.parseInstant( documentIdentifier ) );
	}
