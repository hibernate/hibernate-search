...
public record SearchScopeDelegate<E>(TypedSearchScopeImpl<NonStaticMetamodelScope, E> delegate)
		implements SearchScope<E>, SearchScopeSearcher<NonStaticMetamodelScope, E> {
	...
	@Override
	public SearchQuerySelectStep<NonStaticMetamodelScope, ?, EntityReference, E, ?, ?, ?> search(
			PojoScopeSessionContext sessionContext, PojoSelectionLoadingContextBuilder<?> loadingContextBuilder) {
