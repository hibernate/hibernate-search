...
import org.hibernate.search.mapper.pojo.standalone.scope.impl.SearchScopeDelegate;
import org.hibernate.search.mapper.pojo.standalone.scope.impl.SearchScopeSearcher;
...
public class StandalonePojoSearchSession extends AbstractPojoSearchSession
	...
	@Override
	public <T> SearchQuerySelectStep<NonStaticMetamodelScope, ?, EntityReference, T, ?, ?, ?> search(SearchScope<T> scope) {
	...
	private <SR, T> SearchQuerySelectStep<SR, ?, EntityReference, T, ?, ?, ?> search(SearchScopeSearcher<SR, T> scope) {
