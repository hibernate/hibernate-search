	...
	private static class Builder implements InstructionsStep, AgentMainStateStep, AgentOptionsStep {
		...
		public AgentMainStateStep considerEventProcessingSuspendedThenPulse() {
			expectedInstructionsExpiration =
					AbstractMassIndexerAgentClusterLinkTest.NOW.plus( AbstractMassIndexerAgentClusterLinkTest.PULSE_INTERVAL );
		...
		public AgentOptionsStep agent(UUID expectedId, AgentState expectedCurrentState) {
			...
			this.expectedSelfAgentExpiration = AbstractMassIndexerAgentClusterLinkTest.NOW
					.plus( AbstractMassIndexerAgentClusterLinkTest.PULSE_EXPIRATION );
			return this;
		}
