...
public class BatchSyncProcessor {
	...
	private final MultiWriteDrainableLinkedList<Changeset> transferQueue = new MultiWriteDrainableLinkedList<Changeset>();
	...
	private class Consumer implements Runnable {
		...
		private void applyChangesets(Iterable<Changeset> changesets) {
			...
			try {
				LuceneBackendQueueTask luceneBackendQueueTask = new LuceneBackendQueueTask( changesetList.copyToList(), resources, null );
