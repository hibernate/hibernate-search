...
public class UpdateWorkExecutor implements LuceneWorkExecutor {
	...
	@Override
	public void performWork(final LuceneWork work, IndexWriterDriver driver, final IndexingMonitor monitor) {
		...
		this.deleteDelegate.performWork( work, driver, monitor );
