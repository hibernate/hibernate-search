...
final class StringEntityReferenceFactory implements EntityReferenceFactory<String> {
	...
	@Override
	public String createEntityReference(String typeName, Object identifier) {
