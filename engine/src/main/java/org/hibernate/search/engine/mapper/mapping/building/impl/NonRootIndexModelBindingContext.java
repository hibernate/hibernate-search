...
class NonRootIndexModelBindingContext
	...
	@Override
	public <I> void idConverter(ToIndexIdValueConverter<I> idConverter) {
		throw new AssertionFailure(
				"idConverter(ToIndexIdValueConverter) was called on a non-root binding context; this should never happen."
		);
	}
