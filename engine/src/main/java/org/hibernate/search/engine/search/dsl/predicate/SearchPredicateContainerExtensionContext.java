...
public interface SearchPredicateContainerExtensionContext {
	 ...
	 * {@link #ifSupported(SearchPredicateContainerContextExtension, Function)}
	...
	/**
	 * If no extension passed to {@link #ifSupported(SearchPredicateContainerContextExtension, Function)}
	 ...
	 * Should generally be a lambda expression.
	 */
	SearchPredicate orElse(Function<SearchPredicateContainerContext, SearchPredicate> predicateContributor);
