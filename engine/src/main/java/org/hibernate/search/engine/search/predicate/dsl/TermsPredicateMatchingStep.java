...
public interface TermsPredicateMatchingStep<N extends TermsPredicateOptionsStep<?>> {
	...
	default N matchingAny(Collection<?> terms) {
		return matchingAny( terms, PredicateValueConvert.MAPPING );
	}
	...
	default N matchingAny(Collection<?> terms, org.hibernate.search.engine.search.common.ValueConvert convert) {
		return matchingAny( terms, org.hibernate.search.engine.search.common.ValueConvert.toPredicateValueConvert( convert ) );
	}
	 ...
	 * @return The next step.
	 */
	N matchingAny(Collection<?> terms, PredicateValueConvert convert);
	...
	default N matchingAll(Collection<?> terms) {
		return matchingAll( terms, PredicateValueConvert.MAPPING );
	}
	 ...
	 * See {@link org.hibernate.search.engine.search.common.ValueConvert} for more information.
	 * @return The next step.
	 * @deprecated Use {@link #matchingAll(Collection, PredicateValueConvert)} instead.
	 */
	@Deprecated
	default N matchingAll(Collection<?> terms, org.hibernate.search.engine.search.common.ValueConvert convert) {
		return matchingAll( terms, org.hibernate.search.engine.search.common.ValueConvert.toPredicateValueConvert( convert ) );
	}
	 ...
	 * @return The next step.
	 */
	N matchingAll(Collection<?> terms, PredicateValueConvert convert);
