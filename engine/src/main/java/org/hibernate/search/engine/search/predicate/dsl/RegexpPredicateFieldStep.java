 ...
 */
public interface RegexpPredicateFieldStep<SR, N extends RegexpPredicateFieldMoreStep<SR, ?, ?>> {
	 ...
	 */
	@Incubating
	default N field(RegexpPredicateFieldReference<SR> fieldReference) {
	...
	default N fields(RegexpPredicateFieldReference<SR>... fields) {
