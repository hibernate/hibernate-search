...
public class RangeAggregationFieldStepImpl<PDF extends SearchPredicateFactory> implements RangeAggregationFieldStep<PDF> {
	...
	public RangeAggregationFieldStepImpl(SearchAggregationDslContext<?, PDF> dslContext) {
		this.dslContext = dslContext;
	}

	@Override
	public <F> RangeAggregationRangeStep<?, F, PDF> field(String absoluteFieldPath, Class<F> type, ValueConvert convert) {
