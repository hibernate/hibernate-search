...
/**
 * An extension to {@link FromDocumentIdentifierValueConvertContext}, allowing to access non-standard context
 ...
 *
 * @see FromDocumentIdentifierValueConvertContext#extension(FromDocumentIdentifierValueConvertContextExtension)
 */
public interface FromDocumentIdentifierValueConvertContextExtension<T> {
	 ...
	 *
	 * @param original The original, non-extended {@link FromDocumentIdentifierValueConvertContext}.
	 ...
	 */
	Optional<T> extendOptional(FromDocumentIdentifierValueConvertContext original, BackendSessionContext sessionContext);
