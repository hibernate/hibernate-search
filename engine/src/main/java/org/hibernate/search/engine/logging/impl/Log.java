...
public interface Log extends BasicLogger {
	...
	@Message(id = ID_OFFSET + 33, value = "No backend registered for backend name: '%1$s'.")
	SearchException noBackendRegistered(String backendName);

	@Message(id = ID_OFFSET + 34, value = "No index manager registered for index manager name: '%1$s'.")
	...
	@Message(id = ID_OFFSET + 46, value = "Found an infinite IndexedEmbedded recursion involving path '%1$s' on type '%2$s'.")
	...
	@Message(id = ID_OFFSET + 57, value = "'%1$s' instance cannot be parsed from value: '%2$s', using the expected formatter: '%3$s'.")
	...
	@Message(id = ID_OFFSET + 59, value = "Invalid '%1$s' value for type '%2$s'.")
	SearchException invalidStringForType(String value, @FormatWith(ClassFormatter.class) Class<?> type, @Cause Exception cause);

	@Message(id = ID_OFFSET + 60, value = "Invalid '%1$s' value for enum '%2$s'.")
	...
	@Message(id = ID_OFFSET + 64, value = "Unable to parse the provided geo-point value: '%1$s'. The expected format is latitude, longitude.")
	...
	@Message(id = ID_OFFSET + 75, value = "No default backend registered.")
	SearchException noDefaultBackendRegistered();

	@Message(id = ID_OFFSET + 76, value = "Multiple beans registered for type '%1$s': %2$s.")
	...
	@Message(id = ID_OFFSET + 77, value = "No beans registered for type '%1$s'.")
	SearchException noConfiguredBeanReferenceForType(@FormatWith(ClassFormatter.class) Class<?> exposedType);

	@Message(id = ID_OFFSET + 78, value = "No beans registered for type '%1$s' and name '%2$s'.")
	SearchException noConfiguredBeanReferenceForTypeAndName(@FormatWith(ClassFormatter.class) Class<?> exposedType,
			String nameReference);

	@Message(id = ID_OFFSET + 79, value = "Cannot resolve bean reference to type '%1$s' and name '%2$s'."
	...
	@Message(id = ID_OFFSET + 80, value = "Cannot resolve bean reference to type '%1$s'."
	...
	@Message(id = ID_OFFSET + 81, value = "Configuration property '%1$s' is not set, and no backend was found in the classpath."
	...
	@Message(id = ID_OFFSET + 82, value = "Configuration property '%1$s' is not set, and multiple backend types were found in the classpath."
	...
	@Message(id = ID_OFFSET + 87, value = "Trying to get the exact total hit count, but it is a lower bound.")
	SearchException notExactTotalHitCount();

	@Message(id = ID_OFFSET + 88, value = "Trying to target the same index '%1$s' from different types: '%2$s', '%3$s'. ")
