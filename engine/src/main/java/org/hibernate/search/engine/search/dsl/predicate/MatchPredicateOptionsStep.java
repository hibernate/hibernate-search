 ...
 */
public interface MatchPredicateOptionsStep
		extends PredicateFinalStep, PredicateScoreStep<MatchPredicateOptionsStep> {
	 ...
	 * @see #fuzzy(int, int)
	 */
	default MatchPredicateOptionsStep fuzzy(int maxEditDistance) {
	 ...
	 * @return {@code this}, for method chaining.
	 */
	MatchPredicateOptionsStep fuzzy(int maxEditDistance, int exactPrefixLength);
