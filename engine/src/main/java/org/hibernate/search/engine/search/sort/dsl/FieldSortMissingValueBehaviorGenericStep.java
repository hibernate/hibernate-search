 ...
 *
 * @param <T> The type of the missing value to use.
 * @param <N> The type of the next step (returned by {@link FieldSortMissingValueBehaviorGenericStep#first()}, for example).
 *
 * @author Emmanuel Bernard emmanuel@hibernate.org
 */
public interface FieldSortMissingValueBehaviorGenericStep<T, N> {
