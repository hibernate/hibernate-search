...
public interface TypedSearchSortFactory<SR> extends SearchSortFactory {
	 ...
	 */
	@Override
	FieldSortOptionsStep<SR, ?, ? extends TypedSearchPredicateFactory<SR>> field(String fieldPath);
	 ...
	 * The default order is <strong>ascending</strong>.
	 *
	 * @param fieldReference The field reference representing a <a href="#field-references">definition</a> of the index field to sort by.
	 * @return A DSL step where the "field" sort can be defined in more details.
	 * @throws SearchException If the field doesn't exist or cannot be sorted on.
	 */
	@Incubating
	<T> FieldSortOptionsGenericStep<SR, T, ?, ?, ? extends TypedSearchPredicateFactory<SR>> field(
	 ...
	 */
	@Override
	DistanceSortOptionsStep<SR, ?, ? extends TypedSearchPredicateFactory<SR>> distance(String fieldPath, GeoPoint location);
	 ...
	 * The default order is <strong>ascending</strong>.
	 *
	 * @param fieldReference The field reference representing a <a href="#field-references">definition</a> of the index field
	 * containing the location to compute the distance from.
	 * @param location The location to which we want to compute the distance.
	 * @return A DSL step where the "distance" sort can be defined in more details.
	 * @throws SearchException If the field type does not constitute a valid location.
	 */
	@Incubating
	default DistanceSortOptionsStep<SR, ?, ? extends TypedSearchPredicateFactory<SR>> distance(
	 ...
	 */
	@Override
	default DistanceSortOptionsStep<SR, ?, ? extends TypedSearchPredicateFactory<SR>> distance(String fieldPath,
			double latitude,
			double longitude) {
	 ...
	 */
	@Override
	SortThenStep<SR> composite(Consumer<? super CompositeSortOptionsCollector<?>> elementContributor);
	...
	@Override
	@Incubating
	TypedSearchSortFactory<SR> withRoot(String objectFieldPath);
