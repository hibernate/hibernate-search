 ...
 */
public interface TermsAggregationFieldStep<E, PDF extends SearchPredicateFactory<E>> {
	 ...
	 */
	default <F> TermsAggregationOptionsStep<E, ?, PDF, F, Map<F, Long>> field(String fieldPath, Class<F> type) {
	 ...
	 * @return The next step.
	 */
	<F> TermsAggregationOptionsStep<E, ?, PDF, F, Map<F, Long>> field(String fieldPath, Class<F> type,
